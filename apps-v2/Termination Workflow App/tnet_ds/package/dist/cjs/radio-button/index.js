...
var StyledCheckboxHelperText = (0, import_material4.styled)(FormHelperText)(({
  theme
}) => {
...
var StyledFormControlLabel = (0, import_styles.styled)(import_material5.FormControlLabel)(
  ({ theme }) => {
...
var StyledFormLabel = (0, import_styles2.styled)(import_material6.FormLabel)(({ theme }) => ({
  color: theme.palette.typography.color,
...
var FormLabel = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StyledFormLabel, { ...propsWithDefault });
};

// lib/radio-button/component.tsx
var import_jsx_runtime7 = require("react/jsx-runtime");
var StyledRadio = (0, import_styles3.styled)(import_material7.Radio)(({ theme }) => ({
...
var RadioGroup = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_material7.RadioGroup, { "data-testid": "radio-group", ...props });
};
var RadioWithCMS = ({ contentId }) => {
  const intl = (0, import_react_intl.useIntl)();
  const keys = Object.keys(intl.messages).filter(
    (key) => key.startsWith(`${contentId}.list.0.items`)
  );
  const options = keys.filter((_, index) => index % 2 === 0).map((key, index) => ({
    label: intl.messages[key],
    value: intl.messages[keys[index * 2 + 1]]
  }));
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(FormControl, { "data-testid": "radio-cms", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(FormLabel, { id: "buttons-group-label", children: intl.formatMessage({
      id: `${contentId}.selectLabel`,
      defaultMessage: " "
    }) }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      RadioGroup,
      {
        ...
        children: options.map(({ label, value }) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          FormControlLabel,
          {
            value,
            control: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Radio, {}),
