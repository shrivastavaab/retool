...
var StyledTimeline = (0, import_material3.styled)(import_lab.Timeline)(({ theme }) => {
  return {
...
var TimelineContent = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    import_lab.TimelineContent,
    {
      ...
      "data-testid": "T1-timeline-content",
      children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_material.Stack, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_material.Stack, { direction: "row", spacing: 1, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Typography,
            {
              className: "T1-timeline-primaryContent",
              variant: "paragraphSm",
              children: props.primaryContent
            }
          ),
          props.secondaryContent && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Typography,
            {
              variant: "paragraphSm",
              className: "T1-timeline-secondaryContent",
              children: props.secondaryContent
            }
          )
        ] }),
        props.tertiaryContent && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          Typography,
          {
            variant: "caption",
            className: "T1-timeline-secondaryContent",
            children: props.tertiaryContent
          }
        )
      ] })
    }
...
var Timeline = StyledTimeline;
var TimelineItem = import_lab.TimelineItem;
var TimelineSeparator = import_lab.TimelineSeparator;
var TimelineDot = import_lab.TimelineDot;
var TimelineConnector = import_lab.TimelineConnector;
