...
var nested_table_exports = {};
__export(nested_table_exports, {
  NestedTable: () => NestedTable,
  NestedTableBody: () => NestedTableBody,
  NestedTableCellBody: () => NestedTableCellBody,
  NestedTableCellHead: () => NestedTableCellHead,
  NestedTableContainer: () => NestedTableContainer,
  NestedTableHead: () => NestedTableHead,
  NestedTableRow: () => import_material4.TableRow,
  Table: () => import_material5.Table,
  TableRow: () => import_material5.TableRow,
  nestedTableTheme: () => nestedTableTheme
});
module.exports = __toCommonJS(nested_table_exports);
...
var NestedTableContainer = (props) => {
  const StyledTableContainer = (0, import_styles2.styled)(import_material4.TableContainer)(
    ({ theme }) => ({
  ...
  const StyledTableDivider = (0, import_styles2.styled)(Divider)(({ theme }) => ({
    borderStyle: "dashed",
    borderColor: theme.palette.nestedTable.border,
    marginBottom: theme.spacing(2.5)
  }));
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StyledTableDivider, {}),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StyledTableContainer, { ...props, className: "T1-nested-table-container", children: props.children })
  ] });
};
var NestedTable = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_material4.Table, { ...props, className: "T1-nested-table", children: props.children });
};
var NestedTableHead = (props) => {
  const StyledTableHead = (0, import_styles2.styled)(import_material4.TableHead)(
    ({ theme }) => ({
      th: {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StyledTableHead, { ...props, className: "T1-nested-table-head", children: props.children });
};
var NestedTableBody = (props) => {
  ...
  const StyledTableBody = (0, import_styles2.styled)(import_material4.TableBody)(
    ({ theme }) => ({
      th: {
        border: 0,
        padding: `0 ${theme.spacing(6)} ${theme.spacing(3)} 0`
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StyledTableBody, { ...omitCustomProps(propsWithDefault, ["divider"]), children: props.children });
};
...
var NestedTableCellBody = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    import_material4.TableCell,
    {
      ...
      "aria-label": props.children?.toString(),
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Typography, { variant: "paragraphSm", weight: "regular", display: "block", children: props.children })
    }
  );
};
