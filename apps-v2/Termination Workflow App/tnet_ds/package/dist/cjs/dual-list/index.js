...
// lib/dual-list/index.ts
var dual_list_exports = {};
__export(dual_list_exports, {
  DualList: () => DualList,
  ListContainer: () => ListContainer
});
module.exports = __toCommonJS(dual_list_exports);
...
var InputLabel = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_material12.InputLabel, { ...props });
};

// lib/text-field/component.tsx
var import_jsx_runtime11 = require("react/jsx-runtime");
var TextField = (0, import_react6.forwardRef)(
...
var StyledOutlinedInput = (0, import_styles7.styled)(import_material13.OutlinedInput)(
...
var InputAdornment = (props) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_material14.InputAdornment, { ...props });
...
var StyledFormControlLabel = (0, import_styles8.styled)(import_material15.FormControlLabel)(
  ({ theme }) => {
...
var FormControlLabel = (props) => {
  ...
  const [checked, setChecked] = import_react7.default.useState(false);
  const [isFocusedByClick, setIsFocusedByClick] = import_react7.default.useState(false);
  const getCMSContent = useGetCMSContent();
  ...
  const clonedControl = import_react7.default.cloneElement(
    control,
    {
      setFocused,
      setChecked
...
var Divider = (props) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_material16.Divider, { ...props });
...
// lib/dual-list/component.tsx
var import_icons_material3 = require("@mui/icons-material");
var import_react8 = require("react");
var import_jsx_runtime16 = require("react/jsx-runtime");
var LIST_CONTAINER_HEIGHT = 400;
var LIST_CONTAINER_WIDTH = 250;
var EMPTY_LIST_MESSAGE = "No items available";
var toggleItemSelection = (items, id, selected) => {
  return items.map((item) => item.id === id ? { ...item, selected } : item);
};
var ListItemRow = ({
  item,
  showDivider,
  onCheckboxChange
}) => /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_material.Box, { role: "listitem", children: [
  /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_material.Box, { sx: { padding: 3 }, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
    FormControlLabel,
    {
      control: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
        Checkbox,
        {
          ...
          slotProps: {
            input: { "aria-label": `Select ${item.label}` }
          },
          "data-testid": "t1-dual-list-list-container-checkbox"
        }
      ),
      label: item.label
    }
  ) }),
  showDivider && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Divider, {})
] });
var ListContainer = ({
  list,
  onChange,
  ...
  const [searchTerm, setSearchTerm] = (0, import_react8.useState)(void 0);
  const filteredList = (0, import_react8.useMemo)(() => {
    if (!searchTerm) return list;
    return list.filter(
      (item) => item.label.toLowerCase().includes(searchTerm.toLowerCase())
    );
  }, [searchTerm, list]);
  const selectedItems = (0, import_react8.useMemo)(() => {
    return list.filter((item) => item.selected).length;
  }, [list]);
  const handleSearchInputChange = (0, import_react8.useCallback)(
    (e) => {
      setSearchTerm(e.target.value);
    },
    []
  );
  const handleCheckboxChange = (0, import_react8.useCallback)(
    (e, id) => {
      const updatedList = toggleItemSelection(list, id, e.target.checked);
      onChange?.(updatedList, listIndex);
    },
    [list, onChange, listIndex]
  );
  const handleSelectAll = (0, import_react8.useCallback)(() => {
    const updatedList = list.map((item) => ({ ...item, selected: true }));
    onChange?.(updatedList, listIndex);
  }, [list, onChange, listIndex]);
  const handleClearAll = (0, import_react8.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
    import_material.Stack,
    {
      padding: 4,
      spacing: 3,
      className: "T1-depth-1",
      height: LIST_CONTAINER_HEIGHT,
      width: LIST_CONTAINER_WIDTH,
      borderRadius: 1,
      "data-testid": "t1-dual-list-list-container",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
          TextField,
          {
            ...
            slotProps: {
              htmlInput: {
                "aria-label": "Search items in list"
              },
              input: {
                startAdornment: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(InputAdornment, { position: "start", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_icons_material3.Search, { "data-testid": "t1-dual-list-search-icon" }) })
              }
            }
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_material.Stack, { direction: "row", spacing: 3, children: [
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
            Button,
            {
              variant: "link",
              ...
              "data-testid": "t1-dual-list-list-container-select-all",
              children: "Select All"
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
            Button,
            {
              ...
              "data-testid": "t1-dual-list-list-container-clear-all",
              children: "Clear All"
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
          Typography,
          {
            ...
            "aria-live": "polite",
            "aria-atomic": "true",
            "data-testid": "t1-dual-list-selected-count",
            children: [
              selectedItems,
              " of ",
              list.length,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
          import_material.Stack,
          {
            ...
            sx: { overflowY: "auto" },
            role: "list",
            "aria-label": title ?? "Selectable items",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Divider, {}),
              list.length < 1 && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                import_material.Box,
                {
                  display: "flex",
                  alignItems: "center",
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                    Typography,
                    {
                      ...
                      fontWeight: "medium",
                      color: "secondary",
                      children: EMPTY_LIST_MESSAGE
                    }
                  )
                }
              ),
              filteredList.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                ListItemRow,
                {
                  item,
...
var DualList = ({
  ...
  const onListChange = (0, import_react8.useCallback)(
    (list, index) => {
  ...
  const handleMoveClick = (0, import_react8.useCallback)(
    (direction) => {
      let newLists = [...lists];
      if (direction === "right") {
        const movedItems = newLists[0].filter((item) => item.selected);
        const list1 = newLists[0].filter((item) => !item.selected);
        const list2 = [...newLists[1], ...movedItems];
        newLists = [list1, list2];
      } else {
        const movedItems = newLists[1].filter((item) => item.selected);
        const list1 = [...newLists[0], ...movedItems];
        const list2 = newLists[1].filter((item) => !item.selected);
        newLists = [list1, list2];
      }
      onChange?.(newLists);
    },
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
    import_material.Stack,
    {
      ...
      direction: "row",
      role: "region",
      "aria-label": "Dual list selector",
      "data-testid": "t1-dual-list",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
          ListContainer,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_material.Stack, { gap: 3, height: "100%", justifyContent: "center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
            IconButton2,
            {
              variant: "secondary",
              shape: "circle",
              "aria-label": `Move ${lists[0].filter((item) => item.selected).length} selected items to right list`,
              disabled: !lists[0].some((item) => item.selected),
              onClick: () => {
                handleMoveClick("right");
              },
              "data-testid": "t1-dual-list-move-right",
              children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_icons_material3.KeyboardArrowRight, {})
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
            IconButton2,
            {
              variant: "secondary",
              shape: "circle",
              "aria-label": `Move ${lists[1].filter((item) => item.selected).length} selected items to left list`,
              disabled: !lists[1].some((item) => item.selected),
              onClick: () => {
                handleMoveClick("left");
              },
              "data-testid": "t1-dual-list-move-left",
              children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_icons_material3.KeyboardArrowLeft, {})
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
