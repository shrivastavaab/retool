...
// lib/highlighted-text/index.ts
var highlighted_text_exports = {};
__export(highlighted_text_exports, {
  HighlightedText: () => HighlightedText
});
module.exports = __toCommonJS(highlighted_text_exports);
...
// lib/highlighted-text/component.tsx
var import_jsx_runtime3 = require("react/jsx-runtime");
var HighlightedText = ({ text, match }) => {
  const escapedMatch = match.replace(/[-\\^$*+?.()|[\]{}]/g, "\\$&");
  const regex = new RegExp(escapedMatch, "i");
  const matchResult = text.match(regex);
  if (!matchResult) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Typography, { children: text });
  }
  ...
  const array = [beforeMatch, matchedText, afterMatch].filter(
    (str) => str !== ""
  );
  const matchPosition = array.indexOf(matchedText);
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_material.Stack, { direction: "row", component: "span", "aria-label": text, children: array.map((item, index) => {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      Typography,
      {
        whiteSpace: "preserve",
        weight: index === matchPosition ? "bold" : "regular",
        children: item
      },
      item
    );
