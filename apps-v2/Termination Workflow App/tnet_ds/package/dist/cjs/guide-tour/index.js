...
// lib/guide-tour/index.ts
var guide_tour_exports = {};
__export(guide_tour_exports, {
  GuideTour: () => GuideTour,
  guideTourTheme: () => guideTourTheme
});
module.exports = __toCommonJS(guide_tour_exports);
...
var StyledDotIndicatorsContainer = (0, import_styles10.styled)(import_material.Box)(() => ({
  display: "flex",
  justifyContent: "center",
  alignItems: "center"
}));
var StyledDot = (0, import_styles10.styled)(Button, {
...
var DotIndicators = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(StyledDotIndicatorsContainer, { "data-testid": "T1-dot-indicators", children: Array.from({ length: count }).map((_, index) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
    StyledDot,
    {
      tabIndex: 0,
...
var StyledPopover = (0, import_material17.styled)(import_material18.Popover)(({ theme }) => {
...
var Step = (0, import_material17.styled)(import_material.Box)(
  ({ theme, activeStep }) => {
    const palette = guideTourTheme(theme);
    return {
      width: 6,
...
var StyledOverlay = (0, import_material17.styled)(import_material.Box)(({ theme }) => {
  const palette = guideTourTheme(theme);
  return {
    position: "fixed",
    top: 0,
...
var GuideTour = ({ steps, onClose }) => {
  const [activeStep, setActiveStep] = (0, import_react8.useState)(0);
  const [anchorEl, setAnchorEl] = (0, import_react8.useState)(null);
  const [popoverOrigin, setPopoverOrigin] = (0, import_react8.useState)({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(StyledOverlay, {}),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
      StyledPopover,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(Card2, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
            CardHeader2,
            {
              divider: true,
              ...
              action: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                IconButton2,
                {
                  ...
                  onClick: onClose,
                  "aria-label": "close",
                  children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_Close.default, {})
                }
              )
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(CardContent2, { children: steps[activeStep]?.content }),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(CardActions2, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
              Button,
              {
                onClick: handlePrev,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Button, { onClick: handleNext, children: activeStep === steps.length - 1 ? "End" : "Next" })
          ] })
        ] })
      }
    )
