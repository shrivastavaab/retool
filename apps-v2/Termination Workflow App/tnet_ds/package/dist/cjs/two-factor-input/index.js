...
// lib/two-factor-input/index.ts
var two_factor_input_exports = {};
__export(two_factor_input_exports, {
  TwoFactorInput: () => TwoFactorInput
});
module.exports = __toCommonJS(two_factor_input_exports);

// lib/two-factor-input/component.tsx
...
var InputLabel = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_material2.InputLabel, { ...props });
};
...
var FormHelperText = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_material3.FormHelperText, { ...props, variant: "outlined", children: [
...
var TwoFactorInput = ({
  ...
  const [values, setValues] = (0, import_react3.useState)(
    value.length ? value.split("") : Array(CODE_LENGTH).fill("")
  );
  const inputsRef = (0, import_react3.useRef)([]);
  const handleChange = (value2, index) => {
    if (!/^\d*$/.test(value2)) return;
    const newValues = [...values];
    newValues[index] = value2;
    setValues(newValues);
    if (value2 && index < CODE_LENGTH - 1) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_material.Box, { display: "flex", gap: 1, children: values.map((value2, index) => {
    const key = index + 1;
