...
var Action = ({
  ...
  actionProps ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
    Button,
    {
      onClick: actionProps.callback,
      variant: actionProps.variant === "primary" ? "contrastOutlineReverse" : "contrastReverse",
      size: "extraSmall",
      children: actionProps.label
    }
  ) : "",
  /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(IconButton2, { variant: "transparentReverse", size: "small", onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_icons_material3.Close, {}) })
] });
var Snackbar = ({
  actionProps,
  message,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
    StyledSnackbar,
    {
      ...
      message: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
        showIcon && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_icons_material3.InfoOutlined, {}),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Typography, { children: message })
      ] }),
      action: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Action, { actionProps, onClose }),
      onClose,
      ...rest
    }
  );
};
var StyledSnackbar = (0, import_styles7.styled)(import_material13.Snackbar)(
  ({ theme }) => ({
    ".MuiSnackbarContent-root": {
      ...
      ".MuiSnackbarContent-message": {
        ...
        ".MuiTypography-root": {
          color: theme.palette.snackbar.text,
          fontSize: theme.typography.paragraph.sm.regular.fontSize,
          lineHeight: theme.typography.paragraph.sm.regular.lineHeight,
          fontFamily: theme.typography.paragraph.sm.regular.fontFamily
        }
