...
// lib/side-bar-navigation/index.ts
var side_bar_navigation_exports = {};
__export(side_bar_navigation_exports, {
  SideIconItem: () => SideIconItem,
  sideIconItemTheme: () => sideIconItemTheme
});
module.exports = __toCommonJS(side_bar_navigation_exports);

// lib/layout/index.ts
var import_material = require("@mui/material");

// lib/side-bar-navigation/componet.tsx
...
var StyledIconItem = (0, import_styles2.styled)(import_material.Stack, {
  shouldForwardProp: (props) => props !== "isSubMenu"
})(({ theme, isSubMenu }) => {
  return {
    display: "flex",
    flexDirection: "row",
    height: isSubMenu ? "40px" : "48px",
    ...
    "&:hover, &.T1-hover": {
      ".MuiTypography-root, svg": {
        color: theme.palette.sideIconItem.hover.color
      }
    },
    "&:focus, &.T1-focus": {
      outline: `1px dashed ${theme.palette.sideIconItem.focus.border}`,
      ".MuiTypography-root, svg": {
        color: theme.palette.sideIconItem.hover.color
      }
    },
    "&.selected": {
      backgroundColor: theme.palette.sideIconItem.selected.background,
      borderLeft: `2px solid ${theme.palette.sideIconItem.selected.icon.color}`,
      ".MuiTypography-root": {
        color: theme.palette.sideIconItem.hover.color
      },
      svg: {
        color: theme.palette.sideIconItem.selected.icon.color
      },
      "svg:not(:first-child)": {
        color: theme.palette.sideIconItem.hover.color
      },
    ...
    ".MuiTypography-root, svg": {
      color: theme.palette.sideIconItem.color
    },
    svg: {
      fontSize: isSubMenu ? "16px" : "24px"
    }
  };
});
var SideIconItem = ({
  ...
  const isMainMenu = variant === "main";
  const isSubMenu = variant === "sub";
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    StyledIconItem,
    {
      ...
      children: [
        ...
        (isMainMenu || isSubMenu) && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Typography,
            {
              variant: isMainMenu ? "paragraphMd" : "paragraphSm",
              weight: isSelected ? "medium" : "regular",
              display: "block",
              children: label
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_KeyboardArrowRight.default, {})
        ] })
      ]
    }
  );
