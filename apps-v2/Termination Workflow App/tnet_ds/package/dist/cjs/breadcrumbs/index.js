...
var StyledMenuItem = (0, import_styles.styled)(import_material.MenuItem)(({ theme }) => ({
...
var StyledBreadcrumbsItem = (0, import_material3.styled)(import_material4.Button)(({ theme }) => {
...
var StyledBreadcrumbsSubItem = (0, import_material3.styled)(MenuItem)(({ theme }) => {
  const palette = breadcrumbsTheme(theme);
  return {
    height: 48,
...
var StyledMenu = (0, import_styles2.styled)(import_material5.Menu)(() => ({
  padding: 0,
  ".MuiList-root": {
    padding: 0
  }
  ...
  ({ contentId, variant, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      StyledMenu,
      {
        ...
        "data-testid": "menu",
        children: keys.map((item) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(MenuItem, { children: item }, item.toString()))
      }
    );
  }
);
...
var Breadcrumbs = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_material6.Breadcrumbs, { ...props, children: props.children });
};
var BreadcrumbsItem = ({
  title,
  icon,
  ...
  const handleBreadcrumbsItemClick = (e) => {
    e.preventDefault();
    console.log("a");
    if (subItems) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      StyledBreadcrumbsItem,
      {
        ...
        className: `${anchorEl ? "T1-breadcrumbsItem-active" : ""} ${rest.className ?? ""}`,
        onClick: handleBreadcrumbsItemClick,
        children: [
          icon,
          " ",
          title,
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            ...
            {
              className: `T1-breadcrumbsItem-arrow ${anchorEl ? "T1-active" : ""}`
            }
          )
        ]
      }
    ),
    subItems && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Menu, { open: !!anchorEl, anchorEl, onClose: handleMenuClose, children: subItems.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      StyledBreadcrumbsSubItem,
      {
        className: `${item.active && "T1-breadcrumbsSubItem-active"}`,
        onClick: item.onClick,
        children: item.navLinkProps ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          NavLink,
          {
            ...omitCustomProps(item.navLinkProps, ["className"]),
            className: `T1-breadcrumbs-navLink ${item.navLinkProps.className || ""}`,
            children: [
              item.startIcon,
              item.title,
              item.endIcon
