...
var Autocomplete = (props) => {
  const [suggestion, setSuggestion] = (0, import_react3.useState)("");
  const [internalInputValue, setInternalInputValue] = (0, import_react3.useState)("");
  ...
  const renderTabAutofillInput = (params) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_material5.Box, { position: "relative", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      TextField,
      {
        ...{
          ...params,
        ...
        slotProps: {
          input: {
            ...
            endAdornment: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
              suggestionDisplay && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
  ...
  return props.variant === "regular" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
    import_material5.Autocomplete,
    {
      ...omitCustomProps(props, ["componentsProps", "variant"]),
      slotProps: {
