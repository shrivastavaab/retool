...
// lib/grid/component.tsx
var import_react7 = require("react");
var import_ag_grid_react = require("ag-grid-react");

// lib/layout/index.ts
var import_material = require("@mui/material");

// lib/grid/customNoRowsOverlay.tsx
var import_jsx_runtime = require("react/jsx-runtime");
var CustomNoRowsOverlay = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_material.Box, { children: props.noRowsMessageFunc() });
};
...
var TablePaginationActions = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_material.Box, { className: "MuiTablePagination-container", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_material.Stack, { className: "MuiTablePagination-actions", direction: "row", children: [
      showFirstButton && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        IconButton,
        {
          disabled: page === 0,
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_icons_material.FirstPage, {})
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        IconButton,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_icons_material.KeyboardArrowLeft, {})
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        IconButton,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_icons_material.KeyboardArrowRight, {})
        }
      ),
      showLastButton && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        IconButton,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_icons_material.LastPage, {})
        }
      )
    ] })
  ] });
...
var CustomPaginationLabel = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_material.Box, { className: "MuiTablePagination-displayedRowsContainer", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Typography, { className: "MuiTablePagination-displayedRows", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "MuiTablePagination-displayedRange", children: `${from}-${to}` }),
  ...
  switch (theme.name) {
    ...
    default:
      return {
        ...
        borderColor: theme.palette.t1.system.misty,
        header: {
...
var TableWrapperWithVariables = (0, import_styles3.styled)(import_material.Box)(
  ({ theme }) => {
    const palette = gridTheme(theme);
    return `
      --ag-foreground-color: ${palette.color};
      --ag-font-family: "Centra Regular";
      --ag-borders: none;
      --ag-border-radius: 0px;
      --ag-panel-background-color: ${palette.background};
      --ag-wrapper-border-radius: 0px;
      --ag-background-color: ${palette.background};

      --ag-header-height: 50px;
      --ag-header-column-separator-display: block;
      --ag-header-column-separator-height: 100%;
      --ag-header-column-separator-width: 1px;
      --ag-header-background-color: ${palette.header.background};
      --ag-header-foreground-color: ${palette.color};
      --ag-header-column-separator-color: ${palette.borderColor};

      --ag-row-border-style: solid;
      --ag-row-height: 72px;
      --ag-row-border-width: 1px;
      --ag-row-border-color: ${palette.borderColor};
      --ag-row-hover-color: ${palette.header.background};

      --ag-cell-horizontal-border: ${palette.borderColor};
      --ag-cell-horizontal-padding: ${theme.spacing(4)};
      --ag-header-cell-hover-background-color: ${palette.header.hover.background};
      .ag-theme-material, .ag-theme-T1 {
        --ag-foreground-color: ${palette.color};
        --ag-checkbox-checked-color: ${theme.palette.checkbox.default.checked};
        --ag-checkbox-unchecked-color: ${theme.palette.checkbox.default.unchecked};

        --ag-material-accent-color: ${theme.palette.checkbox.default.checked};
        --ag-font-family: "Centra Regular";
        --ag-borders: none;
        --ag-border-radius: 0px;
        --ag-panel-background-color: ${palette.background};
...
var PaginationWrapper = (0, import_styles3.styled)(import_material.Box)(({ theme }) => ({
...
var Pagination = (props) => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(PaginationWrapper, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Paginator, { ...props }) });
var TableWrapper = (0, import_styles3.styled)(TableWrapperWithVariables)(({ theme, isOverlayVisible }) => {
  const palette = gridTheme(theme);
  return {
    position: "relative",
    display: "flex",
    ...
    "&.ag-theme-T1, &.ag-theme-material": {
      flexGrow: 1,
      display: "flex",
      flexDirection: "column",
      "--ag-header-column-separator-display": isOverlayVisible ? "none" : "block",
      ".ag-header-cell": {
        ...theme.typography.paragraph.sm.bold,
...
var StyledChipButton = (0, import_styles4.styled)(import_material5.Button)(({
  theme
}) => {
...
var StyledToggleIconButton = (0, import_styles4.styled)(import_material5.Button)(({ theme, buttontype = "center", selected = false }) => {
...
var StyledSimpleIconButton = (0, import_styles4.styled)(import_material5.IconButton)(({ theme, variant, selected }) => ({
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
          "svg",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("circle", { cx: "44", cy: "44", r: "20.2" })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_material7.CircularProgress, { ...props, size: SIZE_MAP[size] })
      ]
    }
  );
};
...
var StyledMenuItem = (0, import_styles5.styled)(import_material8.MenuItem)(({ theme }) => ({
...
var StyledMenu = (0, import_styles6.styled)(import_material9.Menu)(() => ({
  padding: 0,
  ".MuiList-root": {
    padding: 0
  }
  ...
  ({ contentId, variant, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      StyledMenu,
      {
        ...
        "data-testid": "menu",
        children: keys.map((item) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(MenuItem, { children: item }, item.toString()))
      }
    );
  }
);
...
var FormHelperText = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_material10.FormHelperText, { ...props, variant: "outlined", children: [
    props.error && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_icons_material2.WarningAmberOutlined, {}),
    props.children
  ] });
};
...
var Drawer = import_react6.default.forwardRef(
  ({
    title,
    content,
    anchor,
    ...
    const [open, setOpen] = import_react6.default.useState(openProp ?? false);
    import_react6.default.useEffect(() => {
      if (openProp !== void 0) {
        setOpen(openProp);
      }
    }, [openProp]);
    const isDesktop = (0, import_useMediaQuery2.default)("(min-width:600px)");
    ...
    const Puller = () => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_material.Box, { className: "MuiDrawer-header", ...handlers, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_material.Box, { component: "span", className: "draggable" }) });
    const isDefault = () => {
      return variant === "default";
    };
    const DrawerContent = (anchor2) => /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
      import_material.Box,
      {
        sx: { width: anchor2 === "top" || anchor2 === "bottom" ? "auto" : 420 },
        onKeyDown: (e) => {
          if (e.key === "Escape") {
            handleClose(e);
          }
        ...
        "aria-label": title,
        "aria-live": "polite",
        className: `${!isDefault() ? "T1-drawerContainer" : ""}`,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
            import_material.Box,
            {
              className: `MuiDrawer-header ${!isDefault() ? "T1-drawerContainer" : ""}`,
              "aria-hidden": "true",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Typography, { variant: "h3", children: title }),
                !isDefault() && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_Close.default, { onClick: handleClose })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
            import_material.Box,
            {
              className: `MuiDrawer-container ${!isDefault() ? "T1-drawerContainer" : ""}`,
              "aria-label": "Content",
              children: content
            }
          ),
          !isDefault() && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
            import_material.Box,
            {
              className: "MuiDrawer-footer",
              "aria-label": "Footer",
              component: "footer",
              children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
                Button,
                {
                  "data-testid": "close-button-inner",
                  variant: "secondary",
                  onClick: handleClose,
                  children: "Close"
                }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
      import_material.Box,
      {
        ...
        className: `${!isDefault() ? "T1-drawerContainer" : ""}`,
        children: [
          element && import_react6.default.cloneElement(element, { onClick: handleOpen }),
          isDesktop ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
            import_material14.Drawer,
            {
              ...
              ref,
              ModalProps: {
                disablePortal: !isDefault()
              },
              PaperProps: { sx: { position: "absolute" } },
              hideBackdrop,
              children: DrawerContent(anchor ?? "left")
            }
          ) : /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
            import_material14.SwipeableDrawer,
            {
              ...
              hideBackdrop,
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Puller, {}),
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_material.Box, { className: "MuiDrawer-container", "aria-label": "Content", children: content })
              ]
            }
          )
        ]
...
// lib/grid/component.tsx
var import_ag_grid = require("ag-grid-community/styles/ag-grid.css");
var import_ag_theme_material = require("ag-grid-community/styles/ag-theme-material.css");
...
var Grid = (props) => {
  ...
  const [rowsPerPage, setRowsPerPage] = (0, import_react7.useState)(paginationPageSize ?? 10);
  const defaultColDef = (0, import_react7.useMemo)(() => {
    return {
      suppressMenu: !columnPin
    };
  }, [columnPin]);
  const noRowsOverlayComponentParams = (0, import_react7.useMemo)(() => {
    return {
      noRowsMessageFunc: () => noRowsMessage
    };
  }, [noRowsMessage]);
  const columnDefs = (0, import_react7.useMemo)(
    () => cols.map((col) => ({
      ...col,
      filter: col.filter || filter,
      resizable,
      flex: 1
    })),
    [cols, filter, resizable]
  );
  const handlePageChange = (_event, newPage) => {
    if (page > newPage) gridRef.current?.api.paginationGoToPreviousPage();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
    TableWrapper,
    {
      className: "ag-theme-material ag-theme-T1",
      style,
      isOverlayVisible,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
          Drawer,
          {
            title: props.isOverlayVisible ? props.drawerTitle ?? "" : "",
            anchor: overlayPosition,
            content: OverlayContent,
            variant: "inner",
            hideBackdrop: blockClicks,
            open: isOverlayVisible,
            onClose: props.isOverlayVisible ? props.onCloseOverlay : () => {
            }
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
        ...
        pagination && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
          Pagination,
          {
            count: rows.length,
            page,
