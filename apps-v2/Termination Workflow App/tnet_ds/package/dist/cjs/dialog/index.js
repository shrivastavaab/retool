  ...
  switch (theme.name) {
    case "dark":
      return {
        ...
        icon: theme.palette.t1.system.cloudy
      };
    case "light":
      return {
...
var StyledDialogTitle = (0, import_material4.styled)(import_material4.DialogTitle)(
  ({ theme }) => {
    const palette = dialogTheme(theme);
    return {
...
var StyledDialogContent = (0, import_material4.styled)(import_material4.DialogContent)(
  ({ theme }) => {
    const palette = dialogTheme(theme);
    return {
...
var StyledDialogActions = (0, import_material4.styled)(import_material4.DialogActions)(
  ({ theme }) => ({
    padding: theme.spacing(4, 6),
    display: "block"
  })
);
var StyledIconButton = (0, import_material4.styled)(IconButton)(
  ({ theme }) => {
    const palette = dialogTheme(theme);
    return {
      "& svg": {
        color: `${palette.icon} !important`
      }
    };
  }
);
...
var Dialog = import_react2.default.forwardRef(
  (props, ref) => {
    const propsWithDefault = {
      onClose: () => {
      },
    ...
    const { onClose, title, actions, children, ...res } = propsWithDefault;
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      import_material5.Dialog,
      {
        ...
        ...res,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StyledDialogTitle, { id: "alert-dialog-title", children: title }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            StyledIconButton,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_icons_material.Close, {})
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StyledDialogContent, { dividers: true, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Typography,
            {
              variant: "paragraphSm",
              weight: "regular",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StyledDialogActions, { children: actions })
        ]
      }
    );
  }
