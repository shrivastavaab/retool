...
var require_isBetween = __commonJS({
  "../../node_modules/dayjs/plugin/isBetween.js"(exports, module2) {
    !function(e, i) {
      "object" == typeof exports && "undefined" != typeof module2 ? module2.exports = i() : "function" == typeof define && define.amd ? define(i) : (e = "undefined" != typeof globalThis ? globalThis : e || self).dayjs_plugin_isBetween = i();
    }(exports, function() {
      "use strict";
...
var require_isSameOrAfter = __commonJS({
  "../../node_modules/dayjs/plugin/isSameOrAfter.js"(exports, module2) {
    !function(e, t) {
      "object" == typeof exports && "undefined" != typeof module2 ? module2.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).dayjs_plugin_isSameOrAfter = t();
    }(exports, function() {
      "use strict";
      return function(e, t) {
...
var require_isSameOrBefore = __commonJS({
  "../../node_modules/dayjs/plugin/isSameOrBefore.js"(exports, module2) {
    !function(e, i) {
      "object" == typeof exports && "undefined" != typeof module2 ? module2.exports = i() : "function" == typeof define && define.amd ? define(i) : (e = "undefined" != typeof globalThis ? globalThis : e || self).dayjs_plugin_isSameOrBefore = i();
    }(exports, function() {
      "use strict";
      return function(e, i) {
...
var StyledPickersDay = (0, import_material.styled)(import_x_date_pickers.PickersDay)(({ theme }) => {
  return {
...
var StyledCalendar = (0, import_material.styled)(import_x_date_pickers.DateCalendar)(({ theme }) => ({
  height: "auto",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    StyledPickersDay,
    {
      ...
      children: [
        ...
        regularEvents && regularEvents.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", gap: "2px", marginTop: "2px" }, children: regularEvents.map((event, index) => {
          const eventType = typeof event === "string" ? event : event.type;
...
var LegendContainer = (0, import_material4.styled)(import_material4.Box)(({ theme }) => ({
  width: "320px",
  display: "flex",
  flexWrap: "wrap",
  gap: theme.spacing(3),
...
var LegendItem = (0, import_material4.styled)(import_material4.Box)(({ theme }) => ({
  display: "flex",
  alignItems: "center",
  gap: theme.spacing(1)
}));
var LegendDot = (0, import_material4.styled)("div")(({
  theme,
  $eventType
}) => {
...
var CalendarLegend = ({
  ...
  const displayedEventTypes = (0, import_react2.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(LegendContainer, { children: displayedEventTypes.map((eventType) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(LegendItem, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(LegendDot, { $eventType: eventType }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Typography, { variant: "paragraphSm", component: "span", children: EVENT_LABELS[eventType] })
  ] }, eventType)) });
};
