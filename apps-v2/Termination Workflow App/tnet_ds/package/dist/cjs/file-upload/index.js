...
__export(file_upload_exports, {
  ...
  Provider: () => Provider,
  fileUploadTheme: () => fileUploadTheme,
  updateFileAtom: () => updateFileAtom,
  useSetAtom: () => useSetAtom
});
module.exports = __toCommonJS(file_upload_exports);

// lib/file-upload/atoms.ts
var import_jotai = require("jotai");
var import_jotai_scope = require("jotai-scope");
var import_vanilla = require("jotai/vanilla");
var filesAtom = (0, import_jotai.atom)([]);
var setFilesAtom = (0, import_jotai.atom)(null, (get, set, newVal) => {
  set(filesAtom, newVal);
});
var updateFileAtom = (0, import_jotai.atom)(null, (get, set, file) => {
...
var deleteFileAtom = (0, import_jotai.atom)(null, (get, set, fileName) => {
  const files = get(filesAtom);
  const index = files.findIndex((item) => item.fileName === fileName);
  if (index !== -1) {
    files.splice(index, 1);
    set(filesAtom, [...files]);
  }
});
var errorAtom = (0, import_jotai.atom)();
var setErrorAtom = (0, import_jotai.atom)(null, (get, set, newValue) => {
  set(errorAtom, newValue);
});
var { Provider, useAtomValue, useSetAtom } = (0, import_jotai_scope.createIsolation)();

// lib/layout/index.ts
var import_material = require("@mui/material");

// lib/file-upload/FileUploadStatus.tsx
      ...
      return {
        ...
        error: {
          container: {
            ...
            secondaryText: theme.palette.t1.error.error30
          },
          icon: {
            background: theme.palette.t1.system.dark70,
    ...
    case "light":
      return {
        ...
        hover: {
          container: {
            background: theme.palette.t1.secondary.blue10,
            border: theme.palette.t1.secondary.blue30
          }
        },
        error: {
          container: {
            border: theme.palette.t1.error.error20,
            secondaryText: theme.palette.t1.error.error50
          },
          icon: {
...
var StyledVisuallyHiddenInput = (0, import_styles2.styled)("input")({
  clip: "rect(0 0 0 0)",
  clipPath: "inset(50%)",
  height: 1,
  overflow: "hidden",
...
var StyledFileUploadFormContainer = (0, import_styles2.styled)(import_material.Box)(
  ({ theme }) => {
    const palette = fileUploadTheme(theme);
    return {
      display: "flex",
      ...
      border: `1px dashed ${palette.default.container.border}`,
      backgroundColor: palette.default.container.background,
      gap: theme.spacing(2),
      width: "568px",
      "&:hover": {
        backgroundColor: palette.hover.container.background,
        border: `1px dashed ${palette.hover.container.border}`
      },
      "&.error": {
        border: `1px dashed ${palette.error.container.border}`,
        svg: {
          color: palette.error.icon.text
        },
        ".iconContainer": {
          backgroundColor: palette.error.icon.background
        }
      },
      svg: {
        color: palette.default.icon.text
      },
      ".iconContainer": {
        backgroundColor: palette.default.icon.background,
        "&.error": {
          svg: {
            color: palette.error.icon.text
          }
      ...
      p: {
        color: palette.default.container.text,
        "&.secondary-text": {
          color: palette.default.container.secondaryText
        }
      }
    };
  }
);
var StyledIconContainer = (0, import_styles2.styled)(import_material.Box)(
  ({ theme }) => ({
    padding: theme.spacing(2),
    borderRadius: theme.spacing(16)
  })
);
var StyledInformationContainer = (0, import_styles2.styled)(import_material.Box)(
  ({ theme }) => {
    const palette = fileUploadTheme(theme);
    return {
      display: "flex",
...
var StyledFileUploadStatusContainer = (0, import_styles2.styled)(import_material.Box)(
  ({ theme }) => {
    const palette = fileUploadTheme(theme);
    return {
      display: "flex",
      ...
      "&.error": {
        ...
        p: {
          "&.error-text": {
            color: palette.error.container.secondaryText
          }
        }
      },
      svg: {
      ...
      ".iconContainer": {
        ...
        "&.trash": {
          ...
          svg: {
            color: palette.default.iconTrash.text,
            cursor: "pointer"
          }
        }
      },
...
var StyledActionContainer = (0, import_styles2.styled)(import_material.Box)(
  ({ theme }) => ({
    width: 470,
    flexDirection: "column",
    gap: theme.spacing(1)
...
var StyledLinearProgress = (0, import_styles2.styled)(LinearProgress)(
  ({ theme }) => ({
    width: 470,
...
var FileUploadStatus = (props) => {
  ...
  const [hasError, setHasError] = (0, import_react2.useState)(
    !!props.file.errorMessage || props.file.sizeError || props.file.formatError
  );
  ...
  (0, import_react2.useEffect)(() => {
    if (props.onFileUpload && !hasError) {
      props.onFileUpload(props.file, updateFile);
    }
  }, []);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    StyledFileUploadStatusContainer,
    {
      className: `${hasError ? "error" : ""}`,
      "data-testid": "T1-file-upload-status",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(StyledIconContainer, { className: "iconContainer", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_UploadFile.default, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(StyledActionContainer, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            ...
            {
              color: props.file.progress !== 100 ? "default" : "success",
              size: "xs",
              value: !hasError ? props.file.progress : 0,
              variant: "determinate"
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            Typography,
            {
              ...
              children: hasError ? props.file.errorMessage : `${bytesToKilobytes(props.file.fileSize).toFixed(0)} KB - ${props.file.progress}% complete`
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          IconButton,
          {
            "data-testid": "T1-file-upload-status-delete-button",
            onClick: () => {
              handleDelete(props.file.fileName);
            },
            children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_DeleteOutline.default, {})
          }
        )
      ]
    }
...
// lib/file-upload/component.tsx
var import_jsx_runtime6 = require("react/jsx-runtime");
var FileUpload = (props) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Provider, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(InternalFileUpload, { ...props }) });
var InternalFileUpload = ({
  maxSize,
  maxFiles = 1,
  onFileUpload,
  accepts
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_material.Stack, { gap: 9, children: [
    files.length !== 1 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      FileUploadForm,
      {
        maxSize,
        maxFiles,
...
// lib/file-upload/FileUploadForm.tsx
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          "svg",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("circle", { cx: "44", cy: "44", r: "20.2" })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_material7.CircularProgress, { ...props, size: SIZE_MAP[size] })
      ]
    }
  );
};
...
var createHTMLTagsMapper = () => {
  ...
  htmlTags.forEach((tag) => {
    mapper[tag] = (chunks) => (0, import_react3.createElement)(tag, {}, chunks);
  });
  return mapper;
};
...
var FormHelperText = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_material10.FormHelperText, { ...props, variant: "outlined", children: [
    props.error && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_icons_material.WarningAmberOutlined, {}),
    props.children
  ] });
};
...
// lib/file-upload/FileUploadForm.tsx
var import_UploadFile2 = __toESM(require("@mui/icons-material/UploadFile"), 1);
...
var FileUploadForm = ({
  ...
  const processedSupportedFiles = accepts.map((file) => `.${file}`).join(",");
  ...
  const getSeparator = (index, accepts2) => {
    if (index === accepts2.length - 2) {
      return " or ";
    } else if (index === accepts2.length - 1) {
      return "";
    } else {
      return ", ";
    }
  ...
  const _handleChange = async (e) => {
    ...
    if (_files.length) {
      if (_files.length > maxFiles) {
        setError(`Upload error. The Max numbers of files is ${maxFiles}`);
        e.target.files = null;
      } else {
        _files.forEach((_file) => {
          if (!_file.processed) {
            _file.errorMessage = null;
            _file.formatError = false;
            _file.sizeError = false;
            _file.progress = 0;
            _file.processed = false;
            _file.fileSize = _file.size;
            _file.fileName = _file.name;
            if (!accepts.includes(getFileExtension(_file))) {
              _file.formatError = true;
              _file.errorMessage = "Unsupported file";
              setError(`Upload error`);
            } else if (bytesToMegabytes(_file.size) > maxSize) {
              _file.sizeError = true;
              _file.errorMessage = `File too large - Maximum size: ${maxSize}MB`;
              setError(`Upload error`);
            } else {
              _file.processed = true;
            }
          }
        });
        setFiles(_files);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
    StyledFileUploadFormContainer,
    {
      ...
      onDrop: handleDrop,
      "data-testid": "T1-file-upload-form",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(StyledIconContainer, { className: `${error ? "error" : ""} iconContainer`, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_UploadFile2.default, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_material.Box, { sx: { display: "indline-flex", alignItems: "center", gap: 1 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
            Button,
            {
              ...
              "data-testid": "T1-file-upload-action-button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
            ...
            {
              type: "file",
              "data-testid": "T1-file-upload-input",
              ref: fileInputRef,
              onChange: _handleChange,
              accept: processedSupportedFiles,
              multiple: maxFiles > 1
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(StyledInformationContainer, { className: `${error ? "error" : ""}`, children: error ? /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_icons_material3.WarningAmber, {}),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
            Typography,
            {
              variant: "paragraphSm",
          ...
          Typography,
          {
            ...
            children: [
              accepts.map(
                (type, index) => `${type.toLocaleUpperCase()}${getSeparator(index, accepts)}`
              ),
