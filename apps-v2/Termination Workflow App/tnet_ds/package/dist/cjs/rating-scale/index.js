...
// lib/rating-scale/index.ts
var rating_scale_exports = {};
__export(rating_scale_exports, {
  RatingScale: () => RatingScale,
  ratingScaleTheme: () => ratingScaleTheme
});
module.exports = __toCommonJS(rating_scale_exports);
...
var Container = (0, import_styles2.styled)(import_material.Box)(({ theme }) => {
  const isMobile = (0, import_material3.useMediaQuery)(theme.breakpoints.down("sm"));
  return {
    display: "flex",
...
var RatingButton = (0, import_styles2.styled)(import_material.Box)(({
  theme,
  selected
}) => {
  const isMobile = (0, import_material3.useMediaQuery)(theme.breakpoints.down("sm"));
...
var RatingIndicator = (0, import_styles2.styled)(import_material.Box)(({ theme }) => {
  const isMobile = (0, import_material3.useMediaQuery)(theme.breakpoints.down("sm"));
  return {
    position: "absolute",
    top: "0",
...
var RatingScale = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Container, { gap: isMobile ? 1 : 2, children: Array.from({ length: maxRating }, (_, i) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      RatingButton,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RatingIndicator, { className: `T1-rating-${ratingValue}` }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Typography, { variant: "paragraphXs", weight: "regular", display: "block", children: ratingValue }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Typography, { variant: "paragraphXs", weight: "regular", display: "block", children: label })
        ]
      },
      ratingValue
    );
