...
// lib/page-footer/index.ts
var page_footer_exports = {};
__export(page_footer_exports, {
  PageFooter: () => PageFooter
});
module.exports = __toCommonJS(page_footer_exports);
...
// lib/page-footer/component.tsx
var import_material4 = require("@mui/material");
var import_jsx_runtime4 = require("react/jsx-runtime");
var StyledFooter = (0, import_material4.styled)(import_material.Stack)(({ theme }) => ({
  backgroundColor: theme.palette.pageFooter.background,
  borderTop: `1px solid ${theme.palette.pageFooter.border}`,
  ".MuiTypography-root": {
    color: theme.palette.pageFooter.text
  },
  ".MuiLink-root": {
    textDecoration: "none",
    ...theme.typography.paragraph.sm.regular,
    color: theme.palette.pageFooter.text,
    "&:hover": {
      color: theme.palette.pageFooter.text,
      "&:after": {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          import_material.Stack,
          {
            ...
            alignItems: "center",
            flexWrap: "wrap",
            children: links.map((link, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link, { href: link.href, children: link.label }, link.label),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_material.Box, { display: { xs: "none", md: "block" }, children: index < links.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Typography, { children: "\u2022" }) })
            ] }))
          }
        )
      ]
