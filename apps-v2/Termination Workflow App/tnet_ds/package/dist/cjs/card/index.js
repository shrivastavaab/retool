...
__export(card_exports, {
  ...
  EventCard: () => EventCard,
  EventCardActions: () => EventCardActions,
  EventCardContent: () => EventCardContent,
  EventCardHeader: () => EventCardHeader,
  EventEmptyCell: () => EventEmptyCell,
  EventFooterCell: () => EventFooterCell,
  EventHeaderCell: () => EventHeaderCell,
  InfoCard: () => InfoCard,
  actionCardHeaderTheme: () => actionCardHeaderTheme,
  cardTheme: () => cardTheme,
  eventCardTheme: () => eventCardTheme,
...
function CustomIcon(props) {
  ...
  const palette = (0, import_react3.useMemo)(() => _checkboxTheme(theme), [theme]);
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_SvgIcon.default, { ...props, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z" }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("rect", { width: "12", height: "12", fill: palette.svgColor, x: "6", y: "6" })
  ] });
}
var Checkbox = ({ setFocused, ...props }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
    import_material9.Checkbox,
    {
      ...
      icon: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(CustomIcon, {}),
      onFocus: () => {
        setFocused?.(true);
      },
      onBlur: () => {
...
var ButtonArrangement = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
    StyledButtonArrangement,
    {
      ...
      children: [
        (contentId && tertiaryButtonContent !== "Content not found" || props.tertiary) && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          Button,
          {
        ...
        (contentId && secondaryButtonContent !== "Content not found" || props.secondary) && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          Button,
          {
            onMouseDown: (e) => {
              e.stopPropagation();
...
var StyledWrapper = (0, import_styles7.styled)(import_material.Box)(({ theme, variant }) => ({
  display: "flex",
  alignItems: "center",
  width: "fit-content",
...
var StyledBox = (0, import_styles7.styled)(import_material.Box)(
  ({
    theme,
    color,
    variant
...
var StyledTypography2 = (0, import_styles7.styled)(Typography)(
  ({ theme, color }) => ({
    color: theme.palette.productBadge[color].color
  })
);
var Vector = (0, import_styles7.styled)(import_material.Box)(
  ({ theme, color }) => ({
    width: 0,
    height: 0,
    position: "absolute",
...
// lib/card/component.tsx
var import_Repeat = __toESM(require("@mui/icons-material/Repeat"), 1);
var import_DeleteOutline = __toESM(require("@mui/icons-material/DeleteOutline"), 1);
var import_AddCircleOutline = __toESM(require("@mui/icons-material/AddCircleOutline"), 1);
...
var List = import_react6.default.forwardRef(
  ({ children, ...rest }, ref) => {
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_material13.List, { ...rest, ref, children });
  }
);
var ListItem = import_react6.default.forwardRef(
  ({
    children,
    className,
    variant = "primary",
...
var ListItemText = import_react6.default.forwardRef(
  (props, ref) => {
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_material13.ListItemText, { ...props, ref });
  }
);
var ListItemIcon = import_react6.default.forwardRef(
  ({ children, ...rest }, ref) => {
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_material13.ListItemIcon, { ...rest, ref, children });
  }
);
...
var StyledUnderlinedSpan = (0, import_styles8.styled)("span")(({ theme }) => ({
  "& > *": {
...
var Tooltip = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
    import_material14.Tooltip,
    {
      ...
      children: underline ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(StyledUnderlinedSpan, { "data-testid": "T1-tooltip-underline", children }) : children
    }
  );
};
var StyledTooltip = (0, import_styles8.styled)(import_material.Box)(({
  theme
}) => {
  return {
...
var StyledInfoCard = (0, import_styles9.styled)(import_material15.Card)(({ theme }) => {
...
var StyledInfoIconContainer = (0, import_styles9.styled)(import_material15.Box)(({ theme }) => {
  const palette = infoCardTheme(theme);
  return {
    display: "flex",
    alignItems: "center",
...
var StyledInfoTextContainer = (0, import_styles9.styled)(import_material15.Box)(({ theme }) => ({
  display: "flex",
...
var StyledEventCard = (0, import_styles9.styled)(import_material15.Card)(({ theme }) => {
...
var StyledEventCardContent = (0, import_styles9.styled)(import_material15.CardContent)(
  ({ theme }) => ({
    padding: theme.spacing(0, 4, 0, 1),
    marginBottom: "8px"
  })
);
var StyledEventCardActions = (0, import_styles9.styled)(import_material15.CardActions)(() => ({
...
var StyledEventMenu = (0, import_styles9.styled)(import_material15.Box)(() => ({
  display: "none",
  position: "absolute",
  right: "5px",
  top: "8px",
...
var StyledEventEmptyCell = (0, import_styles9.styled)(import_material15.Box)(({
  theme
}) => {
  const palette = eventCardTheme(theme);
  return {
...
var StyledEventHeaderCell = (0, import_styles9.styled)(import_material15.Box)(({
  theme
}) => {
  const palette = eventCardTheme(theme);
  return {
...
var StyledEventFooterCell = (0, import_styles9.styled)(import_material15.Box)(({
  theme
}) => {
  const palette = eventCardTheme(theme);
  return {
...
var StyledEventCardHeader = (0, import_styles9.styled)(import_material15.CardHeader)(
  ({ theme }) => ({
    padding: theme.spacing(0, 4, 0, 1),
    marginBottom: "8px"
  })
);
var StyledActionCard = (0, import_styles9.styled)(import_material15.Card)(({ theme }) => {
...
var StyledActionCardHeader = (0, import_styles9.styled)(import_material15.Box)(({ theme, variant = "neutral" }) => {
  const palette = cardTheme(theme);
...
var StyledActionCardContent = (0, import_styles9.styled)(import_material15.Box)(({
  theme
}) => {
  return {
...
var StyledActionCardFooter = (0, import_styles9.styled)(import_material15.Box)(({
  theme
}) => {
  const palette = cardTheme(theme);
  return {
...
var StyledActionCardFooterLeft = (0, import_styles9.styled)(import_material15.Box)(({
  theme
}) => {
  return {
    display: "flex",
...
var StyledActionCardFooterRight = (0, import_styles9.styled)(import_material15.Box)(({
  theme
}) => {
  return {
    display: "flex",
...
var Card2 = ({ variant = "regular", ...rest }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_material16.Card, { variant, ...rest });
};
var CardHeader2 = ({
  divider,
  className,
...
var CardActions2 = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_material16.CardActions, { ...rest, "data-testid": "cardAction", children: [
    ButtonArrangementProps && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
      ButtonArrangement,
      {
        primary: primary && {
...
var CardContent2 = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_material16.CardContent, { ...props, children: contentId ? cardContent : children });
};
var EventCard = ({
  variant = "published",
  onDeleteShift,
  ...
  const [anchorEl, setAnchorEl] = import_react7.default.useState(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(StyledEventCard, { variant, ...rest, children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(StyledEventMenu, { className: "T1-event-menu", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        IconButton2,
        {
          ...
          "aria-haspopup": "true",
          onClick: handleClick,
          children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_icons_material3.MoreVert, {})
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        Menu,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
            MenuItem,
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(ListItemIcon, { children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_DeleteOutline.default, { fontSize: "small" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(ListItemText, { primary: "Delete shift" })
              ]
            }
          )
        }
...
var EventCardHeader = (props) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(StyledEventCardHeader, { ...props });
var EventCardContent = ({
  content,
  ...rest
}) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(StyledEventCardContent, { ...rest, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Typography, { children: content }) });
var EventCardActions = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(StyledEventCardActions, { className: "T1-event-card-actions", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Tooltip, { placement: "top", title: props.content, variant: "light", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(IconButton2, { children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_Repeat.default, {}) }) }) });
};
var EventEmptyCell = (props) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(StyledEventEmptyCell, { onClick: props.action, "data-testid": "event-empty-cell", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_AddCircleOutline.default, {}) });
var EventHeaderCell = (props) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
  StyledEventHeaderCell,
  {
    onClick: props.action,
    "data-testid": "event-header-cell",
    children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_ErrorOutline.default, {})
  }
);
var EventFooterCell = (props) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
  StyledEventFooterCell,
  {
    onClick: props.action,
    "data-testid": "event-footer-cell",
    children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(import_AddCircleOutline.default, {})
  }
);
var ActionCard = ({
  title,
  ...
  const [internalChecked, setInternalChecked] = import_react7.default.useState(checked);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
    StyledActionCard,
    {
      className: `T1-action-card ${className}`,
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
          StyledActionCardHeader,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Typography, { variant: "paragraphMd", weight: "medium", children: title }),
              statusLabel && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
                StatusTag,
                {
                  variant: "neutral",
                  size: "small",
                  "data-testid": "action-card-status-tag",
        ...
        description && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(StyledActionCardContent, { "data-testid": "action-card-content", children: typeof description === "string" ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Typography, { variant: "paragraphSm", children: description }) : description }),
        !hideFooter && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(StyledActionCardFooter, { "data-testid": "action-card-footer", children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(StyledActionCardFooterLeft, { children: !hideCheckbox && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
              Checkbox,
              {
                ...
                slotProps: {
                  input: {
                    "aria-label": checkboxLabel || "Action card checkbox"
                  }
                },
                "data-testid": "action-card-checkbox"
              }
            ),
            checkboxLabel && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
              Typography,
              {
                variant: "paragraphMd",
                component: "label",
                sx: {
                  cursor: disableCheckbox ? "default" : "pointer",
                  userSelect: "none"
                },
                onClick: () => {
                  if (!disableCheckbox) {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(StyledActionCardFooterRight, { children: [
            onSecondaryClick && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
              Button,
              {
                variant: "secondary",
                onClick: onSecondaryClick,
                disabled: disableSecondary,
                "data-testid": "action-card-secondary-button",
                children: secondaryLabel
              }
            ),
            onPrimaryClick && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
              Button,
              {
                onClick: onPrimaryClick,
                disabled: disablePrimary,
                "data-testid": "action-card-primary-button",
...
var InfoCard = ({ icon, label, value }) => {
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(StyledInfoCard, { "data-testid": "info-card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(StyledInfoIconContainer, { "aria-hidden": "true", children: icon }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(StyledInfoTextContainer, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Typography, { variant: "paragraphSm", children: label }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Typography, { variant: "paragraphMd", weight: "medium", children: value })
    ] })
  ] });
};
