...
var Fab = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_material11.Fab, { ...props, "data-testid": "fab-button" });
};
var ChipButton = (props) => {
  const propsWithDefault = {
    ...props
  };
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(StyledChipButton, { ...propsWithDefault, disableRipple: true });
};
var ButtonGroup = (props) => {
  ...
  const childrenWithProps = /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_jsx_runtime9.Fragment, { children: import_react5.default.Children.map(propsWithDefault.children, (child) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_material11.ButtonGroup, { ...omitCustomProps(propsWithDefault, ["children"]), children: childrenWithProps });
};
var DropdownButton = ({
  variant = "primary",
  multiple = false,
  ...
  const [anchorEl, setAnchorEl] = import_react5.default.useState(null);
  const open = Boolean(anchorEl);
  const [internalSelected, setInternalSelected] = import_react5.default.useState(
    () => {
  ...
  const selectedValues = import_react5.default.useMemo(() => {
    if (!isControlled) return internalSelected;
  ...
  const handleItemClick = (item, event) => {
    ...
    let newSelected;
    if (multiple) {
      newSelected = selectedValues.includes(item.value) ? selectedValues.filter((v) => v !== item.value) : [...selectedValues, item.value];
    } else {
  ...
  const renderItems = (items, depth = 0) => items.flatMap((item, index) => {
    const key = `T1-Menuitem-${depth}-${index}`;
    if (item.type === "header") {
      return [
    ...
    const itemLvl = item.lvl ?? depth;
    const itemRole = multiple ? "menuitemcheckbox" : "menuitemradio";
    const labelWeight = !multiple && isSelected ? "medium" : "regular";
    const labelContent = /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_material11.Box, { sx: { display: "flex", flexDirection: "column" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Typography, { variant: "paragraphMd", weight: labelWeight, children: item.label }),
      item.hint && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        Typography,
        {
          variant: "paragraphXs",
          weight: labelWeight,
    ...
    const selectableItem = /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
      MenuItem,
      {
        role: itemRole,
        ...
        children: [
          multiple && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
            Checkbox,
            {
              checked: isSelected,
              disabled: item.disabled,
    ...
    const nested = item.children && item.children.length > 0 ? renderItems(
      item.children.map((child) => ({
        ...child,
        lvl: child.lvl ?? Math.min(depth + 1, 2)
      })),
      depth + 1
    ) : [];
    return [selectableItem, ...nested];
  });
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      Button,
      {
        ...
        endIcon: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_icons_material2.ArrowDropDown, {}),
        variant,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
      Menu,
      {
        ...
        open,
        anchorEl,
        children: renderItems(menuItems)
      }
    )
  ] });
};
...
var SimpleIconButton = ({
  ...
  const [internalSelected, setInternalSelected] = import_react5.default.useState(defaultSelected);
  const isControlled = controlledSelected !== void 0;
  const selected = isControlled ? controlledSelected : internalSelected;
  const handleToggle = import_react5.default.useCallback(() => {
    if (disabled) return;
  ...
  }, [selected, disabled, isControlled, onChange]);
  ...
  const getIcons = () => {
    if (variant === "heart") {
      return {
        filled: import_icons_material2.Favorite,
        outline: import_icons_material2.FavoriteBorder
      };
    }
    return {
      filled: import_icons_material2.Star,
      outline: import_icons_material2.StarBorder
    };
  };
  const icons = getIcons();
  const IconComponent = selected ? icons.filled : icons.outline;
  const defaultAriaLabel = `${selected ? "Remove" : "Add"} ${variant === "heart" ? "favorite" : "star rating"}`;
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
    StyledSimpleIconButton,
    {
      ...
      ...rest,
      children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(IconComponent, {})
    }
  );
};
