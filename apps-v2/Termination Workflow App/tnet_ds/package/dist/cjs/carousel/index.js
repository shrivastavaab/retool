...
var StyledDotIndicatorsContainer = (0, import_styles7.styled)(import_material.Box)(() => ({
  display: "flex",
  justifyContent: "center",
  alignItems: "center"
}));
var StyledDot = (0, import_styles7.styled)(Button, {
...
var DotIndicators = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(StyledDotIndicatorsContainer, { "data-testid": "T1-dot-indicators", children: Array.from({ length: count }).map((_, index) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
    StyledDot,
    {
      tabIndex: 0,
...
var StyledCarousel = (0, import_styles8.styled)(import_material.Box)(({ theme, variant = "primary" }) => {
  const palette = carouselTheme(theme);
  const variantColor = variant === "secondary" ? palette.secondary.color : palette.primary.color;
  return {
    position: "relative",
    margin: "0 auto",
    ...
    ".T1-carousel-circleIcon-container": {
      display: "flex",
      justifyContent: "center",
      marginTop: "31px",
      ".T1-carousel-circleIcon": {
        width: theme.spacing(1.5),
        height: theme.spacing(1.5),
        marginRight: "9px",
        cursor: "pointer",
...
var StyledCarouselSlide = (0, import_styles8.styled)(import_material.Box, {
  shouldForwardProp: (prop) => prop !== "currentIndex" && prop !== "variant"
})(({ currentIndex }) => ({
  flex: "0 0 70%",
  height: "350px",
...
var Carousel = ({
  ...
  const setIndexSlide = (index) => {
    setCurrentIndex(index);
  };
  const getActiveClassName = (index, currentIndex2) => {
    return index === currentIndex2 ? "slide_active" : "slide_inactive";
  };
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(StyledCarousel, { className: "container", variant, children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_material.Box, { className: "T1-carousel", "data-testid": "T1-carousel", children: images.map((image, index) => {
      const key = index + 1;
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        StyledCarouselSlide,
        {
          "data-testid": `T1-carousel_slide_${index}`,
          onClick: () => setIndexSlide(index),
          currentIndex,
          variant,
          className: getActiveClassName(index, currentIndex),
          "aria-label": `image ${index + 1}`,
          children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
            "img",
            {
              className: "T1-carousel-image",
              src: image,
              alt: `Slide ${index}`
            }
          )
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      import_material.Box,
      {
        className: "T1-carousel-circleIcon-container",
        sx: { marginTop: "31px" },
        children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          DotIndicators,
          {
            ...
            ariaLabel: "image",
            enableKeyboardNav: true,
            testIdPrefix: "T1-carousel-circleIcon",
            classNamePrefix: "T1-carousel-circleIcon"
          }
        )
      }
    )
