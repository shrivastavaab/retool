...
var InputAdornment = (props) => /* @__PURE__ */ jsx(MuiInputAdornment, { ...props });
...
var Divider = (props) => /* @__PURE__ */ jsx4(MuiDivider, { ...props });
...
var DayComponent = React.forwardRef(
  (pickersDayProps, ref) => {
    const {
      enableRange,
      enableWeek,
...
var InputLabel = (props) => {
  return /* @__PURE__ */ jsx7(MuiInputLabel, { ...props });
};
...
var FormHelperText = (props) => {
  return /* @__PURE__ */ jsxs(MuiFormHelperText, { ...props, variant: "outlined", children: [
    props.error && /* @__PURE__ */ jsx8(WarningAmberOutlined, {}),
    props.children
  ] });
};
...
var StyledDivider = styled2(Divider)(({ theme }) => ({
  margin: theme.spacing(0, 2),
  width: "10px"
}));
var StyledPopover = styled2(Popover)(({ theme }) => ({
  ".MuiPaper-root": {
    transform: `translateY(${theme.spacing(2)})!important`
  }
}));
var StyledDateField = styled2(DateField)(({ theme }) => ({
  ".MuiInputLabel-root": {
...
var SeparatedInputs = styled2(Stack)(({ theme }) => ({
...
var RangeDatePicker = (props) => {
  ...
  let { value } = props;
  const [dayA, setDayA] = useState3(value[0]);
  const [dayB, setDayB] = useState3(value[1]);
  const dayAFieldRef = useRef(null);
  const dayBFieldRef = useRef(null);
  const [anchorElement, setAnchorElement] = useState3(null);
  const [selectedRange, setSelectedRange] = useState3(0);
  const [isSingleInputFocused, setIsSingleInputFocused] = useState3(false);
  const [resetInteraction, setResetInteraction] = useState3(true);
  useEffect3(() => {
    value = [dayA, dayB];
  ...
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    variant === "regular" || variant === "conjoined" ? /* @__PURE__ */ jsxs2(
      SeparatedInputs,
      {
        direction: "row",
        ...
        children: [
          /* @__PURE__ */ jsx10(
            StyledDateField,
            {
              ...
              InputProps: {
                readOnly: true,
                startAdornment: variant === "conjoined" ? /* @__PURE__ */ jsx10(
                  InputAdornment,
                  {
                    position: "end",
                    ...
                    children: /* @__PURE__ */ jsx10(
                      IconButton,
                      {
                        ...
                        children: /* @__PURE__ */ jsx10(CalendarToday, {})
                      }
                    )
                  }
                ) : null,
                endAdornment: variant !== "conjoined" ? /* @__PURE__ */ jsx10(
                  InputAdornment,
                  {
                    position: "end",
...
var DatePicker = ({
  ...
  const hasInvertedRange = useMemo2(
    () => disabledDates?.some(
      (entry) => isDisabledDateRange(entry) && entry.from.isAfter(entry.to, "day")
    ) ?? false,
    [disabledDates]
  );
  const resolvedShouldDisableDate = useMemo2(
