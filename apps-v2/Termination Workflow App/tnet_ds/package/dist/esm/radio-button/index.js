...
var FormControlLabel = (props) => {
  ...
  const [isFocusedByClick, setIsFocusedByClick] = React.useState(false);
  ...
  const clonedControl = React.cloneElement(
    control,
    {
      setFocused,
      setChecked
...
var FormLabel = (props) => {
  ...
  return /* @__PURE__ */ jsx6(StyledFormLabel, { ...propsWithDefault });
};
...
var RadioGroup = (props) => {
  return /* @__PURE__ */ jsx7(MuiRadioGroup, { "data-testid": "radio-group", ...props });
};
var RadioWithCMS = ({ contentId }) => {
  ...
  return /* @__PURE__ */ jsxs2(FormControl, { "data-testid": "radio-cms", children: [
    /* @__PURE__ */ jsx7(FormLabel, { id: "buttons-group-label", children: intl.formatMessage({
    ...
    /* @__PURE__ */ jsx7(
      RadioGroup,
      {
        ...
        children: options.map(({ label, value }) => /* @__PURE__ */ jsx7(
          FormControlLabel,
          {
            value,
