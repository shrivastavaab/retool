...
var StyledAccordion = styled(Accordion)(({ theme }) => {
...
var StyledAccordionSummary = styled(AccordionSummary)(({ theme }) => {
  const palette = accordionTheme(theme);
  return {
...
var StyledAccordionDetails = styled(AccordionDetails)(({ theme }) => {
  const palette = accordionTheme(theme);
  return {
...
var StyledSummarySection = styled(Box)(({ theme }) => ({
  display: "flex",
...
var AccordionContainer = styled(Stack)(
...
var StyledMenuItem = styled2(MuiMenuItem)(({ theme }) => ({
  fontFamily: theme.typography.paragraph.md.regular.fontFamily,
  fontSize: theme.typography.paragraph.md.regular.fontSize,
  lineHeight: theme.typography.paragraph.md.regular.lineHeight,
  padding: theme.spacing(3),
...
var StyledBreadcrumbsItem = styled3(MuiButton)(({ theme }) => {
...
var StyledBreadcrumbsSubItem = styled3(MenuItem)(({ theme }) => {
  const palette = breadcrumbsTheme(theme);
  return {
    height: 48,
...
var StyledChipButton = styled4(_MuiButton)(({
  theme
}) => {
  const palette = _buttonTheme(theme);
  return {
...
var StyledToggleIconButton = styled4(_MuiButton)(({ theme, buttontype = "center", selected = false }) => {
...
var StyledSimpleIconButton = styled4(IconButton)(({ theme, variant, selected }) => ({
...
var StyledButtonArrangement = styled4(Stack)(({
  theme
}) => {
  return {
    display: "flex",
...
import { Box as Box2, Card, CardActions, CardContent, CardHeader } from "@mui/material";
var StyledInfoCard = styled5(Card)(({ theme }) => {
...
var StyledInfoIconContainer = styled5(Box2)(({ theme }) => {
  const palette = infoCardTheme(theme);
  return {
    display: "flex",
    alignItems: "center",
...
var StyledInfoTextContainer = styled5(Box2)(({ theme }) => ({
  display: "flex",
  flexDirection: "column",
...
var StyledEventCard = styled5(Card)(({ theme }) => {
...
var StyledEventCardContent = styled5(CardContent)(
  ({ theme }) => ({
    padding: theme.spacing(0, 4, 0, 1),
    marginBottom: "8px"
  })
);
var StyledEventCardActions = styled5(CardActions)(() => ({
...
var StyledEventMenu = styled5(Box2)(() => ({
  display: "none",
  position: "absolute",
  right: "5px",
  top: "8px",
...
var StyledEventEmptyCell = styled5(Box2)(({
  theme
}) => {
  const palette = eventCardTheme(theme);
  return {
...
var StyledEventHeaderCell = styled5(Box2)(({
  theme
}) => {
  const palette = eventCardTheme(theme);
  return {
...
var StyledEventFooterCell = styled5(Box2)(({
  theme
}) => {
  const palette = eventCardTheme(theme);
  return {
...
var StyledEventCardHeader = styled5(CardHeader)(
  ({ theme }) => ({
    padding: theme.spacing(0, 4, 0, 1),
    marginBottom: "8px"
  })
);
var StyledActionCard = styled5(Card)(({ theme }) => {
  const palette = cardTheme(theme);
  return {
    backgroundColor: palette.background,
...
var StyledActionCardHeader = styled5(Box2)(({ theme, variant = "neutral" }) => {
  const palette = cardTheme(theme);
...
var StyledActionCardContent = styled5(Box2)(({
  theme
}) => {
  return {
    padding: theme.spacing(6),
...
var StyledActionCardFooter = styled5(Box2)(({
  theme
}) => {
  const palette = cardTheme(theme);
  return {
...
var StyledActionCardFooterLeft = styled5(Box2)(({
  theme
}) => {
  return {
    display: "flex",
...
var StyledActionCardFooterRight = styled5(Box2)(({
  theme
}) => {
  return {
    display: "flex",
      ...
      return {
        [`.${pickersLayoutClasses.contentWrapper}`]: {
          ...
          [`.${dayCalendarClasses.monthContainer}`]: {
            ...
            position: "relative",
            [`&.${pickersSlideTransitionClasses.slideEnterActive}, &.${pickersSlideTransitionClasses.slideExit}`]: {
              position: "absolute"
            }
          },
...
import { yearCalendarClasses as yearCalendarClasses2 } from "@mui/x-date-pickers";
...
import {
  Button as MuiButton3,
  Fab as MuiFab2,
  ButtonGroup as MuiButtonGroup2,
  Box as Box3
} from "@mui/material";
...
var StyledCircularProgressWrapper = styled7(
  "div"
)(({
  theme,
  size,
...
var StyledStepperCircularProgressWrapper = styled7("div")(({
  theme,
  color
}) => {
  const palette = circularProgressTheme(theme);
      ...
      children: [
        /* @__PURE__ */ jsx4(
          "svg",
          {
            ...
            children: /* @__PURE__ */ jsx4("circle", { cx: "44", cy: "44", r: "20.2" })
          }
        ),
        /* @__PURE__ */ jsx4(MuiCircularProgress, { ...props, size: SIZE_MAP[size] })
      ]
    }
  );
};
...
var StyledMenu = styled8(MuiMenu)(() => ({
  padding: 0,
  ".MuiList-root": {
    padding: 0
  }
  ...
  ({ contentId, variant, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ jsx6(
      StyledMenu,
      {
        ...
        "data-testid": "menu",
        children: keys.map((item) => /* @__PURE__ */ jsx6(MenuItem, { children: item }, item.toString()))
      }
    );
  }
);
...
import { Checkbox as MuiCheckbox2 } from "@mui/material";
...
var StyledTypography = styled9(MuiTypography)(({
  theme
}) => {
  return {
...
import {
  Avatar as MuiAvatar2,
  AvatarGroup as MuiAvatarGroup2
} from "@mui/material";

// lib/badge/component.tsx
import { Badge as MuiBadge2 } from "@mui/material";
...
var ProfileContainer = styled10(Box)(() => ({
  display: "flex",
  flexDirection: "column",
  alignItems: "flex-start",
  borderRadius: "6px",
...
var ProfileHeader = styled10(Box)(({ theme }) => ({
  display: "flex",
  padding: "24px",
  alignItems: "flex-start",
  gap: "12px",
...
var ProfileItem = styled10(Box)(({ theme }) => ({
  display: "flex",
  width: "100%",
  padding: "12px",
  gap: "12px",
...
var CompaniesWrapper = styled11(Stack)(({ theme }) => ({
  overflowY: "auto",
  maxHeight: "500px",
  display: "inline-flex",
  flexDirection: "column",
...
var Company = styled11(Stack)(({ theme, disabled }) => ({
  width: "360px",
  height: "44px",
  padding: theme.spacing(3),
  flexDirection: "row",
...
var NotificationWrapper = styled12(Stack)(({ theme }) => ({
  flexDirection: "column",
  alignItems: "flex-start",
  boxSizing: "border-box",
  borderRadius: theme.spacing(1.5),
...
var NotificationHeader = styled12(Stack)(({ theme }) => ({
  boxSizing: "border-box",
  padding: theme.spacing(3),
...
var NotificationFooter = styled12(Stack)(({ theme }) => ({
  width: "100%",
  boxSizing: "border-box",
  padding: theme.spacing(3),
  alignContent: "center",
...
var ButtonFooter = styled12(Button)(() => ({
  display: "flex",
  alignContent: "center"
}));
var NotificationContainer = styled12(Stack)(() => ({
  overflowY: "auto"
}));
var Notification = styled12(Stack)(({ theme }) => ({
  width: "360px",
  padding: theme.spacing(3),
  flexDirection: "column",
  justifyContent: "center",
...
var StyledTypography2 = styled12(Typography)(({ theme }) => ({
...
import { InputLabel as MuiInputLabel2 } from "@mui/material";
import { jsx as jsx16 } from "react/jsx-runtime";
var InputLabel = (props) => {
  return /* @__PURE__ */ jsx16(MuiInputLabel2, { ...props });
};
...
var StyledOutlinedInput = styled13(OutlinedInput)(
...
var StyledFormControlLabel = styled14(MuiFormControlLabel)(
  ({ theme }) => {
...
var StyledFormLabel = styled15(MuiFormLabel)(({ theme }) => ({
  color: theme.palette.typography.color,
  fontSize: theme.typography.paragraph.md.medium.fontSize,
  fontFamily: theme.typography.paragraph.md.medium.fontFamily,
  lineHeight: theme.typography.paragraph.md.medium.lineHeight,
...
var StyledRadio = styled16(MuiRadio)(({ theme }) => ({
  padding: theme.spacing(1),
  ".MuiSvgIcon-root": {
...
var StyledTile = styled17(Box)(({ theme }) => {
  return {
    padding: theme.spacing(6),
    borderRadius: theme.spacing(1),
...
var Tile = styled18(Stack)(({ theme, tilePosition }) => ({
  minWidth: "31px",
  width: "100%",
  padding: theme.spacing(3),
  justifyContent: "center",
...
var InputScaleContainer = styled18(Stack)(
  ({ variant }) => ({
...
import { styled as styled19 } from "@mui/material";
import { jsx as jsx24, jsxs as jsxs10 } from "react/jsx-runtime";
var StyledTimeline = styled19(MuiTimeline)(({ theme }) => {
  return {
...
import { memo as memo2, useEffect as useEffect3, useRef as useRef3, useState as useState3 } from "react";

// lib/icon-button/component.tsx
import { IconButton as MuiIconButton2 } from "@mui/material";
...
var { Provider, useAtom: useMyAtom } = createIsolation();
var clockValues = {
  hours: 12,
  minutes: 60,
  aa: ["AM", "PM"],
...
var initialTimeValuesAtom_ = atom(
  initialTimeValuesAtomStartingValue
);
var timeValuesAtom_ = atomWithDefault(
  (get) => get(initialTimeValuesAtom_)
);
var unconfirmedInputValueAtom_ = atom(
  (get) => parseTimeObject(get(timeValuesAtom_))
);
var inputValueAtom_ = atom(`01:00 AM`);

// lib/divider/component.tsx
import { Divider as MuiDivider2 } from "@mui/material";
import { jsx as jsx26 } from "react/jsx-runtime";
var Divider = (props) => /* @__PURE__ */ jsx26(MuiDivider2, { ...props });

// lib/time-picker/TimePickerFormColumn.tsx
import React6, { memo, useEffect as useEffect2, useRef } from "react";
...
var StyledColumn = styled20(Stack, {
...
var StyledColumnHeader = styled20(Stack)(({ theme }) => ({
  width: "100%",
  height: "40px",
...
var TimePickerFormColumn = memo(
  ({
    ...
    const [scrolling, setScrolling] = React6.useState(false);
    ...
    return /* @__PURE__ */ jsx27(
      StyledColumn,
      {
        ...
        children: /* @__PURE__ */ jsx27("div", { className: "selectionFormColumnScroll", children })
      }
    );
  },
  propsAreEqual
);
var TimePickerFormColumnHeader = memo(
  ({ label }) => {
    return /* @__PURE__ */ jsx27(
      StyledColumnHeader,
      {
        ...
        children: /* @__PURE__ */ jsx27(Typography, { variant: "paragraphSm", children: label })
      }
    );
  }
);
...
var StyledTimePickerFormContainer = styled21(Stack)(({ theme }) => ({
  backgroundColor: theme.palette.timePicker.background,
  "&::before": {
    content: "''",
    position: "absolute",
...
var TimePickerForm = ({
  ...
  const selectionFormRef = useRef2();
  useLayoutEffect(() => {
  ...
  const renderNumbers = (number, column) => {
    return Array.from({ length: number }).map((_, index) => /* @__PURE__ */ jsx28(
      "button",
      {
        onKeyDown: (e) => {
  ...
  const renderStringValues = (values, column) => {
    return values.map((value, index) => /* @__PURE__ */ jsx28(
      "button",
      {
        onKeyDown: (e) => {
          handleSelectionFormButtonKeyDown(e, column);
  ...
  return /* @__PURE__ */ jsxs11(StyledTimePickerFormContainer, { "data-testid": "time-picker-menu", children: [
    /* @__PURE__ */ jsxs11(Stack, { direction: "row", children: [
      /* @__PURE__ */ jsx28(TimePickerFormColumnHeader, { label: "Hour" }),
      /* @__PURE__ */ jsx28(TimePickerFormColumnHeader, { label: "Minute" }),
      /* @__PURE__ */ jsx28(TimePickerFormColumnHeader, { label: "AM/PM" }),
      timeValues.timeZone && /* @__PURE__ */ jsx28(TimePickerFormColumnHeader, { label: "Time zone" })
    ] }),
    /* @__PURE__ */ jsxs11(
      Stack,
      {
        ...
        children: [
          ...
          timeValues.timeZone && /* @__PURE__ */ jsx28(
            TimePickerFormColumn,
            {
              setTimeValues,
              type: "timeZone",
    ...
    /* @__PURE__ */ jsxs11(Stack, { direction: "row", px: 6, py: 4, gap: 3, children: [
      /* @__PURE__ */ jsx28(
        Button,
        {
          onKeyDown: (e) => {
...
import {
  InputAdornment as MuiInputAdornment2
} from "@mui/material";
import { jsx as jsx29 } from "react/jsx-runtime";
var InputAdornment = (props) => /* @__PURE__ */ jsx29(MuiInputAdornment2, { ...props });

// lib/time-picker/component.tsx
import { AccessTime } from "@mui/icons-material";
import { RESET } from "jotai/utils";
import { jsx as jsx30, jsxs as jsxs12 } from "react/jsx-runtime";
var TimePicker_ = memo2(
  ({ variant = "regular", onValueChange }) => {
    const timePickerRef = useRef3();
    const [inputFocused, setInputFocused] = useState3(false);
    const [anchorEl, setAnchorEl] = useState3(null);
    const [selectedRange, setSelectedRange] = useState3(0);
    const [newInteraction, setNewInteraction] = useState3(true);
    ...
    return /* @__PURE__ */ jsxs12(Provider, { children: [
      /* @__PURE__ */ jsx30(
        TextField,
        {
          ...
          InputProps: {
            ...
            ref: timePickerRef,
            endAdornment: /* @__PURE__ */ jsx30(InputAdornment, { position: "end", children: /* @__PURE__ */ jsx30(
              IconButton2,
              {
                variant: "input",
                shape: "circle",
                ...
                children: /* @__PURE__ */ jsx30(AccessTime, {})
              }
            ) })
          }
        }
...
var StyledToggleButton = styled22(Button2)(({ theme, selected, hasIcon, hasLabel }) => {
  return {
    borderRadius: "100px",
    textTransform: "none",
...
var StyledButtonGroup = styled22(Box)(({ theme }) => ({
  display: "flex",
  width: "100%",
  backgroundColor: theme.palette.toggleButton.primary.body,
  padding: theme.spacing(1),
...
var StyledToggle = styled23(Switch)(({ theme }) => ({
  width: "44px",
  height: "24px",
  padding: 0,
  position: "relative",
...
var StyledUnderlinedSpan = styled24("span")(({ theme }) => ({
  "& > *": {
...
var StyledTooltip = styled24(Box)(({
  theme
}) => {
  return {
...
import { GlobalStyles as GlobalStyles2 } from "@mui/material";
...
// lib/theme/themeProvider.tsx
import CentraRegular from "../CentraNo2-Book-WB4IP4OE.woff2";
import CentraMedium from "../CentraNo2-Medium-W5T546CA.woff2";
import CentraBold from "../CentraNo2-Bold-EIQ7MHPN.woff2";
import { jsx as jsx35, jsxs as jsxs14 } from "react/jsx-runtime";
var MuiGlobalStyles = createGlobalStyle`

  @font-face {
    font-family: 'Centra Regular';
    src: local('Centra Regular'), local('Centra Regular');
    src: url(${CentraRegular}) format('woff2');
    font-style: normal;
  }
  ...
  @font-face {
    ...
    src: url(${CentraMedium}) format('woff2');
    font-style: normal;
  }
  ...
  @font-face {
    ...
    src: url(${CentraBold}) format('woff2');
    font-style: normal;
  }
`;
function ThemeProvider({
  ...
  return /* @__PURE__ */ jsxs14(MuiThemeProvider, { theme, children: [
    /* @__PURE__ */ jsx35(MuiGlobalStyles, {}),
    /* @__PURE__ */ jsx35(GenericClasses, {}),
    /* @__PURE__ */ jsx35(ScrollBars, {}),
    children
  ] });
}
...
var getTheme = (themeName, components2) => {
  if (components2.length) {
    ...
    return createTheme2(common, newTheme);
  }
  return common;
};
