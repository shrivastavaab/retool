...
var StyledDotIndicatorsContainer = styled7(Box)(() => ({
  display: "flex",
  justifyContent: "center",
  alignItems: "center"
}));
var StyledDot = styled7(Button, {
...
var DotIndicators = ({
  ...
  return /* @__PURE__ */ jsx10(StyledDotIndicatorsContainer, { "data-testid": "T1-dot-indicators", children: Array.from({ length: count }).map((_, index) => /* @__PURE__ */ jsx10(
    StyledDot,
    {
      tabIndex: 0,
...
var StyledCarousel = styled8(Box)(({ theme, variant = "primary" }) => {
...
var StyledCarouselSlide = styled8(Box, {
...
var Carousel = ({
  ...
  return /* @__PURE__ */ jsxs5(StyledCarousel, { className: "container", variant, children: [
    /* @__PURE__ */ jsx11(Box, { className: "T1-carousel", "data-testid": "T1-carousel", children: images.map((image, index) => {
      const key = index + 1;
