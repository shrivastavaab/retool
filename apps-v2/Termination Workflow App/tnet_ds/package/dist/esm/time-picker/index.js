...
import { memo as memo2, useEffect as useEffect3, useRef as useRef3, useState as useState2 } from "react";
...
var InputLabel = (props) => {
  return /* @__PURE__ */ jsx3(MuiInputLabel, { ...props });
};
...
var FormHelperText = (props) => {
  return /* @__PURE__ */ jsxs(MuiFormHelperText, { ...props, variant: "outlined", children: [
    props.error && /* @__PURE__ */ jsx4(WarningAmberOutlined, {}),
    props.children
  ] });
};
...
var StyledMenu = styled3(MuiMenu)(() => ({
  padding: 0,
  ".MuiList-root": {
    padding: 0
  }
  ...
  ({ contentId, variant, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ jsx8(
      StyledMenu,
      {
        ...
        "data-testid": "menu",
        children: keys.map((item) => /* @__PURE__ */ jsx8(MenuItem, { children: item }, item.toString()))
      }
    );
  }
);
      ...
      children: [
        /* @__PURE__ */ jsx9(
          "svg",
          {
            ...
            children: /* @__PURE__ */ jsx9("circle", { cx: "44", cy: "44", r: "20.2" })
          }
        ),
        /* @__PURE__ */ jsx9(MuiCircularProgress, { ...props, size: SIZE_MAP[size] })
      ]
    }
  );
};
...
var StyledTypography = styled7(MuiTypography)(({
  theme
}) => {
  return {
...
var Divider = (props) => /* @__PURE__ */ jsx13(MuiDivider, { ...props });

// lib/time-picker/TimePickerFormColumn.tsx
import React3, { memo, useEffect as useEffect2, useRef } from "react";
...
var StyledColumn = styled8(Stack, {
...
var StyledColumnHeader = styled8(Stack)(({ theme }) => ({
  width: "100%",
  height: "40px",
...
var TimePickerFormColumn = memo(
  ({
    ...
    const columnRef = React3.useRef(null);
    const [scrolling, setScrolling] = React3.useState(false);
    ...
    return /* @__PURE__ */ jsx14(
      StyledColumn,
      {
        ...
        children: /* @__PURE__ */ jsx14("div", { className: "selectionFormColumnScroll", children })
      }
    );
  },
  propsAreEqual
  ...
  ({ label }) => {
    return /* @__PURE__ */ jsx14(
      StyledColumnHeader,
      {
        ...
        children: /* @__PURE__ */ jsx14(Typography, { variant: "paragraphSm", children: label })
      }
    );
  }
);
...
var StyledTimePickerFormContainer = styled9(Stack)(({ theme }) => ({
  backgroundColor: theme.palette.timePicker.background,
  "&::before": {
    content: "''",
    position: "absolute",
...
var TimePickerForm = ({
  ...
  const renderNumbers = (number, column) => {
    return Array.from({ length: number }).map((_, index) => /* @__PURE__ */ jsx15(
      "button",
      {
        onKeyDown: (e) => {
  ...
  const renderStringValues = (values, column) => {
    return values.map((value, index) => /* @__PURE__ */ jsx15(
      "button",
      {
        onKeyDown: (e) => {
          handleSelectionFormButtonKeyDown(e, column);
  ...
  return /* @__PURE__ */ jsxs5(StyledTimePickerFormContainer, { "data-testid": "time-picker-menu", children: [
    /* @__PURE__ */ jsxs5(Stack, { direction: "row", children: [
      /* @__PURE__ */ jsx15(TimePickerFormColumnHeader, { label: "Hour" }),
      /* @__PURE__ */ jsx15(TimePickerFormColumnHeader, { label: "Minute" }),
      /* @__PURE__ */ jsx15(TimePickerFormColumnHeader, { label: "AM/PM" }),
      timeValues.timeZone && /* @__PURE__ */ jsx15(TimePickerFormColumnHeader, { label: "Time zone" })
    ] }),
    /* @__PURE__ */ jsxs5(
      Stack,
      {
        ...
        children: [
          ...
          timeValues.timeZone && /* @__PURE__ */ jsx15(
            TimePickerFormColumn,
            {
              setTimeValues,
              type: "timeZone",
    ...
    /* @__PURE__ */ jsxs5(Stack, { direction: "row", px: 6, py: 4, gap: 3, children: [
      /* @__PURE__ */ jsx15(
        Button,
        {
          onKeyDown: (e) => {
...
var InputAdornment = (props) => /* @__PURE__ */ jsx16(MuiInputAdornment, { ...props });
...
var TimePicker = ({
  variant = "regular",
  onValueChange
}) => /* @__PURE__ */ jsx17(Provider, { children: /* @__PURE__ */ jsx17(TimePicker_, { variant, onValueChange }) });
var TimePicker_ = memo2(
  ({ variant = "regular", onValueChange }) => {
    ...
    const [selectedRange, setSelectedRange] = useState2(0);
    const [newInteraction, setNewInteraction] = useState2(true);
    ...
    return /* @__PURE__ */ jsxs6(Provider, { children: [
      /* @__PURE__ */ jsx17(
        TextField,
        {
          ...
          InputProps: {
            ...
            ref: timePickerRef,
            endAdornment: /* @__PURE__ */ jsx17(InputAdornment, { position: "end", children: /* @__PURE__ */ jsx17(
              IconButton,
              {
                variant: "input",
                shape: "circle",
                ...
                children: /* @__PURE__ */ jsx17(AccessTime, {})
              }
            ) })
          }
        }
