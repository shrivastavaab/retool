...
var StyledTimeline = styled2(MuiTimeline)(({ theme }) => {
  return {
    ...
    MuiTimelineContent,
    {
      ...
      children: /* @__PURE__ */ jsxs(Stack, { children: [
        /* @__PURE__ */ jsxs(Stack, { direction: "row", spacing: 1, children: [
          ...
          props.secondaryContent && /* @__PURE__ */ jsx3(
            Typography,
            {
              variant: "paragraphSm",
        ...
        props.tertiaryContent && /* @__PURE__ */ jsx3(
          Typography,
          {
            variant: "caption",
            className: "T1-timeline-secondaryContent",
...
var TimelineItem = MuiTimelineItem;
var TimelineSeparator = MuiTimelineSeparator;
var TimelineDot = MuiTimelineDot;
var TimelineConnector = MuiTimelineConnector;
