...
var InputLabel = (props) => {
  return /* @__PURE__ */ jsx10(MuiInputLabel, { ...props });
};
...
var StyledOutlinedInput = styled7(OutlinedInput)(
...
var InputAdornment = (props) => /* @__PURE__ */ jsx12(MuiInputAdornment, { ...props });
...
var StyledFormControlLabel = styled8(MuiFormControlLabel)(
  ({ theme }) => {
...
var FormControlLabel = (props) => {
  ...
  const [isFocusedByClick, setIsFocusedByClick] = React3.useState(false);
  const getCMSContent = useGetCMSContent();
  ...
  const clonedControl = React3.cloneElement(
    control,
    {
      setFocused,
      setChecked
...
var Divider = (props) => /* @__PURE__ */ jsx14(MuiDivider, { ...props });
...
import { useState as useState2, useMemo as useMemo3, useCallback } from "react";
...
var ListItemRow = ({
  ...
  showDivider,
  onCheckboxChange
}) => /* @__PURE__ */ jsxs5(Box, { role: "listitem", children: [
  /* @__PURE__ */ jsx16(Box, { sx: { padding: 3 }, children: /* @__PURE__ */ jsx16(
    FormControlLabel,
    {
  ...
  showDivider && /* @__PURE__ */ jsx16(Divider, {})
] });
var ListContainer = ({
  list,
  onChange,
  ...
  const [searchTerm, setSearchTerm] = useState2(void 0);
  const filteredList = useMemo3(() => {
        ...
        /* @__PURE__ */ jsx16(
          TextField,
          {
            ...
            slotProps: {
              ...
              input: {
                startAdornment: /* @__PURE__ */ jsx16(InputAdornment, { position: "start", children: /* @__PURE__ */ jsx16(Search, { "data-testid": "t1-dual-list-search-icon" }) })
              }
            }
          }
        ),
        /* @__PURE__ */ jsxs5(Stack, { direction: "row", spacing: 3, children: [
          /* @__PURE__ */ jsx16(
            Button,
            {
              variant: "link",
        ...
        /* @__PURE__ */ jsxs5(
          Stack,
          {
            ...
            children: [
              ...
              filteredList.map((item, index) => /* @__PURE__ */ jsx16(
                ListItemRow,
                {
                  item,
  ...
  return /* @__PURE__ */ jsxs5(
    Stack,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs5(Stack, { gap: 3, height: "100%", justifyContent: "center", children: [
          /* @__PURE__ */ jsx16(
            IconButton2,
            {
              variant: "secondary",
              ...
              children: /* @__PURE__ */ jsx16(KeyboardArrowRight, {})
            }
          ),
          /* @__PURE__ */ jsx16(
            IconButton2,
            {
              ...
              children: /* @__PURE__ */ jsx16(KeyboardArrowLeft, {})
            }
          )
        ] }),
        /* @__PURE__ */ jsx16(
