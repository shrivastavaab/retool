...
var StyledDialogTitle = styled2(DialogTitle)(
  ({ theme }) => {
...
var StyledDialogContent = styled2(DialogContent)(
  ({ theme }) => {
    const palette = dialogTheme(theme);
    return {
...
var StyledDialogActions = styled2(DialogActions)(
  ({ theme }) => ({
    padding: theme.spacing(4, 6),
    display: "block"
  })
);
var StyledIconButton = styled2(IconButton)(
  ({ theme }) => {
    const palette = dialogTheme(theme);
    return {
      "& svg": {
  ...
  (props, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      MuiDialog,
      {
        ...
        ...res,
        children: [
          /* @__PURE__ */ jsx4(StyledDialogTitle, { id: "alert-dialog-title", children: title }),
          /* @__PURE__ */ jsx4(
            StyledIconButton,
            {
              ...
              children: /* @__PURE__ */ jsx4(Close, {})
            }
          ),
          /* @__PURE__ */ jsx4(StyledDialogContent, { dividers: true, children: /* @__PURE__ */ jsx4(
            Typography,
            {
              variant: "paragraphSm",
              weight: "regular",
          ...
          /* @__PURE__ */ jsx4(StyledDialogActions, { children: actions })
        ]
      }
    );
  }
