...
var StyledFooter = styled2(Stack)(({ theme }) => ({
      ...
      children: [
        ...
        /* @__PURE__ */ jsx4(
          Stack,
          {
            ...
            alignItems: "center",
            flexWrap: "wrap",
            children: links.map((link, index) => /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx4(Link, { href: link.href, children: link.label }, link.label),
              /* @__PURE__ */ jsx4(Box, { display: { xs: "none", md: "block" }, children: index < links.length - 1 && /* @__PURE__ */ jsx4(Typography, { children: "\u2022" }) })
            ] }))
          }
        )
      ]
