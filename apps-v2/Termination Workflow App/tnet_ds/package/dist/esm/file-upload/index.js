...
var filesAtom = atom([]);
var setFilesAtom = atom(null, (get, set, newVal) => {
  set(filesAtom, newVal);
});
var updateFileAtom = atom(null, (get, set, file) => {
...
var deleteFileAtom = atom(null, (get, set, fileName) => {
...
var errorAtom = atom();
var setErrorAtom = atom(null, (get, set, newValue) => {
  set(errorAtom, newValue);
});
var { Provider, useAtomValue, useSetAtom } = createIsolation();
...
var StyledVisuallyHiddenInput = styled2("input")({
  clip: "rect(0 0 0 0)",
  clipPath: "inset(50%)",
  height: 1,
  overflow: "hidden",
...
var StyledFileUploadFormContainer = styled2(Box)(
  ({ theme }) => {
...
var StyledIconContainer = styled2(Box)(
  ({ theme }) => ({
    padding: theme.spacing(2),
    borderRadius: theme.spacing(16)
  })
);
var StyledInformationContainer = styled2(Box)(
  ({ theme }) => {
    const palette = fileUploadTheme(theme);
    return {
      display: "flex",
...
var StyledFileUploadStatusContainer = styled2(Box)(
  ({ theme }) => {
    const palette = fileUploadTheme(theme);
    return {
      display: "flex",
...
var StyledActionContainer = styled2(Box)(
  ({ theme }) => ({
    width: 470,
    flexDirection: "column",
    gap: theme.spacing(1)
...
var StyledLinearProgress = styled2(LinearProgress)(
  ({ theme }) => ({
    width: 470,
...
var FileUploadStatus = (props) => {
  ...
  return /* @__PURE__ */ jsxs(
    StyledFileUploadStatusContainer,
    {
      ...
      children: [
        /* @__PURE__ */ jsx5(StyledIconContainer, { className: "iconContainer", children: /* @__PURE__ */ jsx5(UploadFileIcon, {}) }),
        /* @__PURE__ */ jsxs(StyledActionContainer, { children: [
          /* @__PURE__ */ jsx5(
            Typography,
            {
              variant: "paragraphMd",
        ...
        /* @__PURE__ */ jsx5(
          IconButton,
          {
            ...
            children: /* @__PURE__ */ jsx5(DeleteOutlineIcon, {})
          }
        )
      ]
    }
...
var FileUpload = (props) => /* @__PURE__ */ jsx6(Provider, { children: /* @__PURE__ */ jsx6(InternalFileUpload, { ...props }) });
var InternalFileUpload = ({
  ...
  return /* @__PURE__ */ jsxs2(Stack, { gap: 9, children: [
    files.length !== 1 && /* @__PURE__ */ jsx6(
      FileUploadForm,
      {
        maxSize,
        maxFiles,
...
var StyledChipButton = styled3(_MuiButton)(({
  theme
}) => {
...
var StyledToggleIconButton = styled3(_MuiButton)(({ theme, buttontype = "center", selected = false }) => {
...
var StyledSimpleIconButton = styled3(IconButton2)(({ theme, variant, selected }) => ({
...
var StyledButtonArrangement = styled3(Stack)(({
  theme
}) => {
  return {
    display: "flex",
...
var StyledCircularProgressWrapper = styled4(
  "div"
)(({
  theme,
  size,
...
var StyledStepperCircularProgressWrapper = styled4("div")(({
  theme,
  color
}) => {
  const palette = circularProgressTheme(theme);
      ...
      children: [
        /* @__PURE__ */ jsx7(
          "svg",
          {
            ...
            children: /* @__PURE__ */ jsx7("circle", { cx: "44", cy: "44", r: "20.2" })
          }
        ),
        /* @__PURE__ */ jsx7(MuiCircularProgress, { ...props, size: SIZE_MAP[size] })
      ]
    }
  );
};
...
import { useEffect as useEffect2, useMemo, useState as useState2, createElement } from "react";
...
var StyledMenuItem = styled5(MuiMenuItem)(({ theme }) => ({
...
var StyledMenu = styled6(MuiMenu)(() => ({
  padding: 0,
  ".MuiList-root": {
    padding: 0
  }
...
var FormHelperText = (props) => {
  return /* @__PURE__ */ jsxs4(MuiFormHelperText, { ...props, variant: "outlined", children: [
...
var StyledCheckboxHelperText = styled7(FormHelperText)(({
  theme
}) => {
...
var FileUploadForm = ({
  ...
  return /* @__PURE__ */ jsxs7(
    StyledFileUploadFormContainer,
    {
      ...
      children: [
        /* @__PURE__ */ jsx14(StyledIconContainer, { className: `${error ? "error" : ""} iconContainer`, children: /* @__PURE__ */ jsx14(UploadFileIcon2, {}) }),
        /* @__PURE__ */ jsxs7(Box, { sx: { display: "indline-flex", alignItems: "center", gap: 1 }, children: [
          /* @__PURE__ */ jsx14(
            Button,
            {
              variant: "link",
        ...
        /* @__PURE__ */ jsx14(StyledInformationContainer, { className: `${error ? "error" : ""}`, children: error ? /* @__PURE__ */ jsxs7(Fragment2, { children: [
          /* @__PURE__ */ jsx14(WarningAmberIcon, {}),
          /* @__PURE__ */ jsx14(
            Typography,
            {
              variant: "paragraphSm",
