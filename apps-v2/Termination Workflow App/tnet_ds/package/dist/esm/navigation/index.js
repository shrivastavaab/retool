...
var Badge = ({
  ...
  const getBadgeContent = (variant2) => {
    switch (variant2) {
      case "add":
        return /* @__PURE__ */ jsx3(Add, {});
      case "info":
        return "i";
      case "remove":
        return /* @__PURE__ */ jsx3(Remove, {});
      default:
        return badgeContent;
    }
  };
...
var ProfileContainer = styled2(Box)(() => ({
  display: "flex",
...
var ProfileHeader = styled2(Box)(({ theme }) => ({
  display: "flex",
  padding: "24px",
  alignItems: "flex-start",
  gap: "12px",
...
var ProfileItem = styled2(Box)(({ theme }) => ({
  display: "flex",
  width: "100%",
  padding: "12px",
  gap: "12px",
...
var Profile = (props) => {
  return /* @__PURE__ */ jsxs(ProfileContainer, { children: [
    /* @__PURE__ */ jsxs(ProfileHeader, { children: [
      props.workerName && /* @__PURE__ */ jsx5(Avatar, { children: getInitials(props.workerName) }),
      /* @__PURE__ */ jsxs(Stack, { children: [
        /* @__PURE__ */ jsx5(Typography, { variant: "paragraphMd", weight: "medium", display: "block", children: props.workerName }),
        /* @__PURE__ */ jsxs(Typography, { variant: "paragraphSm", weight: "regular", display: "block", children: [
          props.workerId,
          " \u2022 ",
    ...
    props.items.map((item, index) => /* @__PURE__ */ jsxs(
      ProfileItem,
      {
        onClick: () => item.action(),
        tabIndex: 0,
        children: [
          item.icon,
          /* @__PURE__ */ jsx5(Typography, { variant: "paragraphSm", weight: "regular", display: "block", children: item.label })
        ]
      },
      index + item.label
    ))
...
var StyledSimpleIconButton = styled3(IconButton)(({ theme, variant, selected }) => ({
      ...
      children: [
        /* @__PURE__ */ jsx6(
          "svg",
          {
            ...
            children: /* @__PURE__ */ jsx6("circle", { cx: "44", cy: "44", r: "20.2" })
          }
        ),
        /* @__PURE__ */ jsx6(MuiCircularProgress, { ...props, size: SIZE_MAP[size] })
      ]
    }
  );
};
  ...
  ({ contentId, variant, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ jsx9(
      StyledMenu,
      {
        ...
        "data-testid": "menu",
        children: keys.map((item) => /* @__PURE__ */ jsx9(MenuItem, { children: item }, item.toString()))
      }
    );
  }
);
...
var FormHelperText = (props) => {
  return /* @__PURE__ */ jsxs3(MuiFormHelperText, { ...props, variant: "outlined", children: [
    props.error && /* @__PURE__ */ jsx10(WarningAmberOutlined, {}),
    props.children
  ] });
};
...
var CompaniesWrapper = styled8(Stack)(({ theme }) => ({
  overflowY: "auto",
  maxHeight: "500px",
  display: "inline-flex",
  flexDirection: "column",
...
var Company = styled8(Stack)(({ theme, disabled }) => ({
  width: "360px",
  height: "44px",
  padding: theme.spacing(3),
  flexDirection: "row",
...
var CompanySelector = ({
  ...
  const [selected, setSelected] = useState2(selectedIndex);
  const [defaultIndex, setDefaultIndex] = useState2(byDefault);
  ...
  return /* @__PURE__ */ jsx13(CompaniesWrapper, { children: companies.map((company, index) => {
    const key = index + 1;
    return /* @__PURE__ */ jsxs6(
      Company,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs6(Stack, { direction: "column", children: [
            /* @__PURE__ */ jsx13(
              Typography,
              {
                variant: "paragraphMd",
            ...
            /* @__PURE__ */ jsxs6(Stack, { direction: "row", gap: 1, children: [
              /* @__PURE__ */ jsx13(
                Typography,
                {
                  variant: "paragraphSm",
          ...
          isSelected(index) && /* @__PURE__ */ jsx13(Stack, { children: /* @__PURE__ */ jsx13(CheckCircleIcon, {}) })
        ]
      },
      key
    );
...
var NotificationWrapper = styled9(Stack)(({ theme }) => ({
  flexDirection: "column",
  alignItems: "flex-start",
  boxSizing: "border-box",
  borderRadius: theme.spacing(1.5),
...
var NotificationHeader = styled9(Stack)(({ theme }) => ({
  boxSizing: "border-box",
  padding: theme.spacing(3),
...
var NotificationFooter = styled9(Stack)(({ theme }) => ({
  width: "100%",
  boxSizing: "border-box",
  padding: theme.spacing(3),
  alignContent: "center",
...
var ButtonFooter = styled9(Button)(() => ({
  display: "flex",
  alignContent: "center"
}));
var NotificationContainer = styled9(Stack)(() => ({
  overflowY: "auto"
}));
var Notification = styled9(Stack)(({ theme }) => ({
  width: "360px",
  padding: theme.spacing(3),
  flexDirection: "column",
...
var StyledTypography2 = styled9(Typography)(({ theme }) => ({
  color: theme.palette.navigationNotification.color
}));
var NotificationBell = (props) => {
  return /* @__PURE__ */ jsxs7(NotificationWrapper, { children: [
    /* @__PURE__ */ jsx14(NotificationHeader, { children: /* @__PURE__ */ jsx14(Typography, { variant: "paragraphMd", weight: "medium", display: "block", children: props.label }) }),
    /* @__PURE__ */ jsx14(NotificationContainer, { children: props.itemNotifications.map((noti, index) => /* @__PURE__ */ jsx14(
      Notification,
      {
        className: noti.readed ? "readed" : "",
        "data-testid": noti.title + index,
        children: /* @__PURE__ */ jsxs7(Stack, { direction: "row", gap: 1.5, children: [
          /* @__PURE__ */ jsx14(ErrorOutlineOutlinedIcon, {}),
          /* @__PURE__ */ jsxs7(Stack, { children: [
            /* @__PURE__ */ jsx14(
              Typography,
              {
                variant: "paragraphMd",
            ...
            noti.actions && /* @__PURE__ */ jsxs7(Stack, { direction: "row", gap: 3, marginTop: 3, children: [
              /* @__PURE__ */ jsx14(Button, { onClick: noti.actions.onDeny, variant: "secondary", children: "Deny" }),
              /* @__PURE__ */ jsx14(Button, { onClick: noti.actions.onApprove, children: "Approve" })
            ] }),
            /* @__PURE__ */ jsx14(
              StyledTypography2,
              {
    ...
    /* @__PURE__ */ jsx14(NotificationFooter, { children: /* @__PURE__ */ jsx14(
      ButtonFooter,
      {
        variant: "link",
