...
var StyledBreadcrumbsItem = styled2(MuiButton)(({ theme }) => {
...
var StyledBreadcrumbsSubItem = styled2(MenuItem)(({ theme }) => {
  const palette = breadcrumbsTheme(theme);
  return {
    height: 48,
...
import { useEffect as useEffect6, useMemo as useMemo5, useState as useState5, createElement as createElement10 } from "react";
...
var createHTMLTagsMapper = () => {
  ...
  htmlTags.forEach((tag) => {
    mapper[tag] = (chunks) => createElement10(tag, {}, chunks);
  });
  return mapper;
};
...
var MenuWithCMS = React12.forwardRef(
...
import { Fragment as Fragment7, jsx as jsx5, jsxs } from "react/jsx-runtime";
var Breadcrumbs = (props) => {
  return /* @__PURE__ */ jsx5(MuiBreadcrumbs, { ...props, children: props.children });
};
var BreadcrumbsItem = ({
  title,
  icon,
  ...
  return /* @__PURE__ */ jsxs(Fragment7, { children: [
    ...
    subItems && /* @__PURE__ */ jsx5(Menu, { open: !!anchorEl, anchorEl, onClose: handleMenuClose, children: subItems.map((item, index) => /* @__PURE__ */ jsx5(
      StyledBreadcrumbsSubItem,
      {
        className: `${item.active && "T1-breadcrumbsSubItem-active"}`,
        onClick: item.onClick,
        children: item.navLinkProps ? /* @__PURE__ */ jsxs(
          NavLink,
          {
