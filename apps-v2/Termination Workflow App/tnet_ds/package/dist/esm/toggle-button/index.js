...
var StyledToggleButton = styled(Button)(({ theme, selected, hasIcon, hasLabel }) => {
  return {
    borderRadius: "100px",
    textTransform: "none",
...
var StyledButtonGroup = styled(Box)(({ theme }) => ({
  display: "flex",
  width: "100%",
  backgroundColor: theme.palette.toggleButton.primary.body,
...
var ToggleButtonGroup = ({
  ...
  return /* @__PURE__ */ jsx3(StyledButtonGroup, { children: options.map((option) => /* @__PURE__ */ jsx3(
    ToggleButton,
    {
      label: option.label,
      icon: option.icon,
