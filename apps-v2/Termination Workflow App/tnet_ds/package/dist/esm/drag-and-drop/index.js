...
var StyledDragAndDropElement = styled2("li", {
...
var StyledDragAndDropContainer = styled2("ul")(({ theme }) => {
  const palette = dragAndDropTheme(theme);
  return {
    position: "relative",
    margin: 0,
...
var StyledDropTarget = styled3(Box, {
...
var DragAndDropElement = ({
  index,
  dragIcon: DragIcon = DragIndicator,
  deleteIcon: DeleteIcon = Delete,
  ...props
}) => {
  const ref = useRef(null);
  const dropTargetTopRef = useRef(null);
  const dropTargetBottomRef = useRef(null);
  ...
  return /* @__PURE__ */ jsxs(StyledDropTarget, { expand, children: [
    /* @__PURE__ */ jsx3(
      Box,
      {
    ...
    /* @__PURE__ */ jsxs(
      StyledDragAndDropElement,
      {
        ...
        children: [
          /* @__PURE__ */ jsx3(DragIcon, { style: { fontSize: "16px" } }),
          /* @__PURE__ */ jsx3(Typography, { variant: "paragraphMd", children: props.children }),
          props.deletable && /* @__PURE__ */ jsx3("button", { onClick: handleDelete, children: /* @__PURE__ */ jsx3(DeleteIcon, {}) })
        ]
      }
    )
  ] });
...
var DragAndDrop = ({
  ...
  return /* @__PURE__ */ jsx3(StyledDragAndDropContainer, { ref, children: innerElements.map(({ label, _id, ...element }, index) => /* @__PURE__ */ jsx3(
    DragAndDropElement,
    {
      showDropTargets,
      setInnerElements,
