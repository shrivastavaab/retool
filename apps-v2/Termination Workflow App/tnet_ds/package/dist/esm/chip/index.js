...
var Chip = ({
  ...
  const [textLabel, setTextLabel] = useState2(chipLabel);
  ...
  return /* @__PURE__ */ jsx5(
    MuiChip,
    {
      ...
      tabIndex: 0,
      avatar: !edit && !withoutAvatar ? /* @__PURE__ */ jsx5(Avatar, { alt: props.alt, src: props.src, size: "small" }) : null,
      className: `T1-chip ${editing ? "T1-chip-editing" : ""} ${edit ? "T1-chip-editable" : ""} ${getSelectedClass()} ${className}`,
      onDelete: handleDeleteClick,
      onClick: handleClick,
      "data-testid": "Chip",
      size: chipSize,
      deleteIcon: /* @__PURE__ */ jsxs(Fragment, { children: [
        edit && (editing ? /* @__PURE__ */ jsx5(
          Check,
          {
            "aria-live": "polite",
            onClick: handleSave,
      ...
      label: !edit ? textLabel : /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx5(
          InputBase,
          {
