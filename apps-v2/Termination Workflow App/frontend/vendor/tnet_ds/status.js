...
var Status = ({
  ...
  return /* @__PURE__ */ jsxs(
    StyledWrapper,
    {
      ...
      children: [
        /* @__PURE__ */ jsx3(StyledCircle, { variant, isLarge }),
        /* @__PURE__ */ jsx3(Typography, { variant: isLarge ? "paragraphLg" : "paragraphMd", children })
      ]
    }
  );
};
var StyledWrapper = styled2(Box)(
  ({ isLarge, theme }) => ({
    display: "flex",
    alignItems: "center",
...
var StyledCircle = styled2("span")(({ isLarge, theme, variant }) => {
